...
func (r Distance) marshalJSON() jsonDistance {
	m := jsonDistance{}
	m.Id = r.Id
...
func (r *Distance) UnmarshalJSON(b []byte) error {
	var m jsonDistance
...
func (r *Distance) unmarshalJSON(m jsonDistance) error {
	r.Id = m.Id

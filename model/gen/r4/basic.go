...
func (r Basic) marshalJSON(w io.Writer) error {
	var err error
	_, err = w.Write([]byte("{"))
	if err != nil {
		return err
	}
	_, err = w.Write([]byte("\"resourceType\":\"Basic\""))
	if err != nil {
		return err
	}
	setComma := true
...
func (r *Basic) unmarshalJSON(d *json.Decoder) error {
	t, err := d.Token()
	if err != nil {
		return err
	}
	if t != json.Delim('{') {
		return fmt.Errorf("invalid token: %v, expected: '{' in Basic element", t)
	}
	for d.More() {
		t, err = d.Token()
		if err != nil {
		...
		f, ok := t.(string)
		if !ok {
			return fmt.Errorf("invalid token: %v, expected: field name in Basic element", t)
		}
		switch f {
		case "resourceType":
			_, err := d.Token()
		...
		case "author":
			...
			r.Author = &v
		default:
			return fmt.Errorf("invalid field: %s in Basic", f)
		}
	}
	t, err = d.Token()
	if err != nil {
...
func (r Basic) Children(name ...string) fhirpath.Collection {
...
func (r Basic) ToBoolean(explicit bool) (fhirpath.Boolean, bool, error) {
	return false, false, errors.New("can not convert Basic to Boolean")
}
func (r Basic) ToString(explicit bool) (fhirpath.String, bool, error) {
	return "", false, errors.New("can not convert Basic to String")
}
func (r Basic) ToInteger(explicit bool) (fhirpath.Integer, bool, error) {
	return 0, false, errors.New("can not convert Basic to Integer")
}
func (r Basic) ToDecimal(explicit bool) (fhirpath.Decimal, bool, error) {
	return fhirpath.Decimal{}, false, errors.New("can not convert Basic to Decimal")
}
func (r Basic) ToDate(explicit bool) (fhirpath.Date, bool, error) {
	return fhirpath.Date{}, false, errors.New("can not convert Basic to Date")
}
func (r Basic) ToTime(explicit bool) (fhirpath.Time, bool, error) {
	return fhirpath.Time{}, false, errors.New("can not convert Basic to Time")
}
func (r Basic) ToDateTime(explicit bool) (fhirpath.DateTime, bool, error) {
	return fhirpath.DateTime{}, false, errors.New("can not convert Basic to DateTime")
}
func (r Basic) ToQuantity(explicit bool) (fhirpath.Quantity, bool, error) {
	return fhirpath.Quantity{}, false, errors.New("can not convert Basic to Quantity")
}
func (r Basic) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {
	var o *Basic

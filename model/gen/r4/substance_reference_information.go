...
func (r SubstanceReferenceInformation) MemSize() int {
	...
	s += (cap(r.Classification) - len(r.Classification)) * int(reflect.TypeOf(SubstanceReferenceInformationClassification{}).Size())
...
func (r SubstanceReferenceInformationClassification) MemSize() int {
	s := int(reflect.TypeOf(r).Size())
	if r.Id != nil {
		s += len(*r.Id) + int(reflect.TypeOf(*r.Id).Size())
	}
...
func (r SubstanceReferenceInformationClassification) marshalJSON(w io.Writer) error {
	var err error
	_, err = w.Write([]byte("{"))
	if err != nil {
		return err
...
func (r *SubstanceReferenceInformationClassification) unmarshalJSON(d *json.Decoder) error {
	t, err := d.Token()
	if err != nil {
		return err
	}
	if t != json.Delim('{') {
		return fmt.Errorf("invalid token: %v, expected: '{' in SubstanceReferenceInformationClassification element", t)
	}
	for d.More() {
		t, err = d.Token()
		if err != nil {
		...
		f, ok := t.(string)
		if !ok {
			return fmt.Errorf("invalid token: %v, expected: field name in SubstanceReferenceInformationClassification element", t)
		}
		switch f {
		case "id":
			var v string
		...
		default:
			return fmt.Errorf("invalid field: %s in SubstanceReferenceInformationClassification", f)
		}
	}
	t, err = d.Token()
	if err != nil {
...
func (r SubstanceReferenceInformation) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {
...
func (r SubstanceReferenceInformationGene) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {
...
func (r SubstanceReferenceInformationGeneElement) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {
...
func (r SubstanceReferenceInformationClassification) ToBoolean(explicit bool) (fhirpath.Boolean, bool, error) {
	return false, false, errors.New("can not convert SubstanceReferenceInformationClassification to Boolean")
}
func (r SubstanceReferenceInformationClassification) ToString(explicit bool) (fhirpath.String, bool, error) {
	return "", false, errors.New("can not convert SubstanceReferenceInformationClassification to String")
}
func (r SubstanceReferenceInformationClassification) ToInteger(explicit bool) (fhirpath.Integer, bool, error) {
	return 0, false, errors.New("can not convert SubstanceReferenceInformationClassification to Integer")
}
func (r SubstanceReferenceInformationClassification) ToDecimal(explicit bool) (fhirpath.Decimal, bool, error) {
	return fhirpath.Decimal{}, false, errors.New("can not convert SubstanceReferenceInformationClassification to Decimal")
}
func (r SubstanceReferenceInformationClassification) ToDate(explicit bool) (fhirpath.Date, bool, error) {
	return fhirpath.Date{}, false, errors.New("can not convert SubstanceReferenceInformationClassification to Date")
}
func (r SubstanceReferenceInformationClassification) ToTime(explicit bool) (fhirpath.Time, bool, error) {
	return fhirpath.Time{}, false, errors.New("can not convert SubstanceReferenceInformationClassification to Time")
}
func (r SubstanceReferenceInformationClassification) ToDateTime(explicit bool) (fhirpath.DateTime, bool, error) {
	return fhirpath.DateTime{}, false, errors.New("can not convert SubstanceReferenceInformationClassification to DateTime")
}
func (r SubstanceReferenceInformationClassification) ToQuantity(explicit bool) (fhirpath.Quantity, bool, error) {
	return fhirpath.Quantity{}, false, errors.New("can not convert SubstanceReferenceInformationClassification to Quantity")
}
func (r SubstanceReferenceInformationClassification) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {
...
func (r SubstanceReferenceInformationTarget) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {

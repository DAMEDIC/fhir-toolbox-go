...
func (r EffectEvidenceSynthesis) MemSize() int {
	...
	s += r.Exposure.MemSize() - int(unsafe.Sizeof(r.Exposure))
	s += r.ExposureAlternative.MemSize() - int(unsafe.Sizeof(r.ExposureAlternative))
	...
	s += (cap(r.ResultsByExposure) - len(r.ResultsByExposure)) * int(unsafe.Sizeof(EffectEvidenceSynthesisResultsByExposure{}))
	for _, i := range r.EffectEstimate {
		s += i.MemSize()
	}
	s += (cap(r.EffectEstimate) - len(r.EffectEstimate)) * int(unsafe.Sizeof(EffectEvidenceSynthesisEffectEstimate{}))
	for _, i := range r.Certainty {
		s += i.MemSize()
	}
	s += (cap(r.Certainty) - len(r.Certainty)) * int(unsafe.Sizeof(EffectEvidenceSynthesisCertainty{}))
	return s
}
...
func (r EffectEvidenceSynthesisResultsByExposure) MemSize() int {
	...
	s += r.RiskEvidenceSynthesis.MemSize() - int(unsafe.Sizeof(r.RiskEvidenceSynthesis))
	return s
}
func (r EffectEvidenceSynthesisEffectEstimate) MemSize() int {
	...
	s += (cap(r.PrecisionEstimate) - len(r.PrecisionEstimate)) * int(unsafe.Sizeof(EffectEvidenceSynthesisEffectEstimatePrecisionEstimate{}))
	return s
}
...
func (r EffectEvidenceSynthesisCertainty) MemSize() int {
	...
	s += (cap(r.CertaintySubcomponent) - len(r.CertaintySubcomponent)) * int(unsafe.Sizeof(EffectEvidenceSynthesisCertaintyCertaintySubcomponent{}))
	return s
}
...
func (r EffectEvidenceSynthesisEffectEstimate) TypeInfo() fhirpath.TypeInfo {
	return fhirpath.ClassInfo{
		Element: []fhirpath.ClassInfoElement{{
			...
			Type: "List<FHIR.EffectEvidenceSynthesisEffectEstimatePrecisionEstimate>",
		}},
		SimpleTypeInfo: fhirpath.SimpleTypeInfo{
			BaseType: fhirpath.TypeSpecifier{
				Name:      "DataType",
...
func (r EffectEvidenceSynthesisCertainty) TypeInfo() fhirpath.TypeInfo {
	return fhirpath.ClassInfo{
		Element: []fhirpath.ClassInfoElement{{
			...
			Type: "List<FHIR.EffectEvidenceSynthesisCertaintyCertaintySubcomponent>",
		}},
		SimpleTypeInfo: fhirpath.SimpleTypeInfo{
			BaseType: fhirpath.TypeSpecifier{
				Name:      "DataType",

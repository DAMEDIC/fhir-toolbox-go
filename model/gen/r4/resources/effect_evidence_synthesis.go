...
type EffectEvidenceSynthesisSampleSize struct {
	...
	NumberOfStudies *types.Integer
	// Number of participants included in this evidence synthesis.
	NumberOfParticipants *types.Integer
...
func (s EffectEvidenceSynthesisSampleSize) String() string {
...
func (s EffectEvidenceSynthesisEffectEstimatePrecisionEstimate) String() string {
	buf, err := json.MarshalIndent(s, "", "  ")
	if err != nil {
		panic(err)
	}
...
type EffectEvidenceSynthesisEffectEstimate struct {
	...
	VariantState *types.CodeableConcept
}

func (s EffectEvidenceSynthesisEffectEstimate) String() string {
	buf, err := json.MarshalIndent(s, "", "  ")
	if err != nil {
		panic(err)
	}
...
type EffectEvidenceSynthesisResultsByExposure struct {
	...
	RiskEvidenceSynthesis types.Reference
	// Unique id for the element within a resource (for internal references). This may be any string value that does not contain spaces.
	Id *string
	// May be used to represent additional information that is not part of the basic definition of the element. To make the use of extensions safe and manageable, there is a strict set of governance  applied to the definition and use of extensions. Though any implementer can define an extension, there is a set of requirements that SHALL be met as part of the definition of the extension.
	Extension []types.Extension
	...
	ExposureState *types.Code
}

func (s EffectEvidenceSynthesisResultsByExposure) String() string {
	buf, err := json.MarshalIndent(s, "", "  ")
	if err != nil {
		panic(err)
	}
...
type EffectEvidenceSynthesisCertaintyCertaintySubcomponent struct {
	...
	Rating []types.CodeableConcept
	// A human-readable string to clarify or explain concepts about the resource.
	Note []types.Annotation
}

func (s EffectEvidenceSynthesisCertaintyCertaintySubcomponent) String() string {
	buf, err := json.MarshalIndent(s, "", "  ")
	if err != nil {
		panic(err)
	}
...
func (s EffectEvidenceSynthesisCertainty) String() string {
	buf, err := json.MarshalIndent(s, "", "  ")
	if err != nil {
		panic(err)
	}
...
type EffectEvidenceSynthesis struct {
	...
	StudyType *types.CodeableConcept
	// A reference to a EvidenceVariable resource that defines the population for the research.
	Population types.Reference
	// The estimated effect of the exposure variant.
...
func (s EffectEvidenceSynthesis) String() string {
	buf, err := json.MarshalIndent(s, "", "  ")
	if err != nil {
		panic(err)
	}

...
func (s MessageDefinitionFocus) String() string {
...
type MessageDefinitionAllowedResponse struct {
	...
	Situation *types.Markdown
}

func (s MessageDefinitionAllowedResponse) String() string {
	buf, err := json.MarshalIndent(s, "", "  ")
	if err != nil {
		panic(err)
	}
...
func (s MessageDefinition) String() string {
	buf, err := json.MarshalIndent(s, "", "  ")
	if err != nil {
		panic(err)
	}

...
type ProcedureFocalDevice struct {
	...
	Manipulated types.Reference
}

func (s ProcedureFocalDevice) String() string {
...
func (s ProcedurePerformer) String() string {
	buf, err := json.MarshalIndent(s, "", "  ")
	if err != nil {
		panic(err)
	}
...
type Procedure struct {
	...
	Complication []types.CodeableConcept
	...
	ComplicationDetail []types.Reference
	...
	UsedCode []types.CodeableConcept
	...
	FollowUp []types.CodeableConcept
}

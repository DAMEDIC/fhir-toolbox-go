...
func (s SearchParameterComponent) String() string {
...
func (s SearchParameter) String() string {
	buf, err := json.MarshalIndent(s, "", "  ")
	if err != nil {
		panic(err)
	}

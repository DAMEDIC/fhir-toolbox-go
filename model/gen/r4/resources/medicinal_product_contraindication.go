...
func (s MedicinalProductContraindicationOtherTherapy) String() string {
...
type MedicinalProductContraindication struct {
	...
	TherapeuticIndication []types.Reference
}

func (s MedicinalProductContraindication) String() string {
	buf, err := json.MarshalIndent(s, "", "  ")
	if err != nil {
		panic(err)
	}

...
func (s MedicinalProductAuthorizationJurisdictionalAuthorization) String() string {
...
func (s MedicinalProductAuthorizationProcedure) String() string {
	buf, err := json.MarshalIndent(s, "", "  ")
	if err != nil {
		panic(err)
	}
...
type MedicinalProductAuthorization struct {
	...
	DateOfFirstAuthorization *types.DateTime
	...
	DataExclusivityPeriod *types.Period
	...
	LegalBasis *types.CodeableConcept
	...
	RestoreDate *types.DateTime
	// Date of first marketing authorization for a company's new medicinal product in any country in the World.
	InternationalBirthDate *types.DateTime
}

func (s MedicinalProductAuthorization) String() string {
	buf, err := json.MarshalIndent(s, "", "  ")
	if err != nil {
		panic(err)
	}

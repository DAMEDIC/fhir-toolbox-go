...
func (s ConceptMapGroupUnmapped) String() string {
...
func (s ConceptMapGroupElementTargetDependsOn) String() string {
	buf, err := json.MarshalIndent(s, "", "  ")
	if err != nil {
		panic(err)
	}
...
type ConceptMapGroupElementTarget struct {
	...
	Equivalence types.Code
}

func (s ConceptMapGroupElementTarget) String() string {
	buf, err := json.MarshalIndent(s, "", "  ")
	if err != nil {
		panic(err)
	}
...
func (s ConceptMapGroupElement) String() string {
	buf, err := json.MarshalIndent(s, "", "  ")
	if err != nil {
		panic(err)
	}
...
func (s ConceptMapGroup) String() string {
	buf, err := json.MarshalIndent(s, "", "  ")
	if err != nil {
		panic(err)
	}
...
func (s ConceptMap) String() string {
	buf, err := json.MarshalIndent(s, "", "  ")
	if err != nil {
		panic(err)
	}

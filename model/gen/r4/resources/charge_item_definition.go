...
func (s ChargeItemDefinitionApplicability) String() string {
...
func (s ChargeItemDefinitionPropertyGroupPriceComponent) String() string {
	buf, err := json.MarshalIndent(s, "", "  ")
	if err != nil {
		panic(err)
	}
...
func (s ChargeItemDefinitionPropertyGroup) String() string {
	buf, err := json.MarshalIndent(s, "", "  ")
	if err != nil {
		panic(err)
	}
...
type ChargeItemDefinition struct {
	...
	DerivedFromUri []types.Uri
}

func (s ChargeItemDefinition) String() string {
	buf, err := json.MarshalIndent(s, "", "  ")
	if err != nil {
		panic(err)
	}

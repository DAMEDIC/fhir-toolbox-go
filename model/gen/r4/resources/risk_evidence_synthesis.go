...
func (s RiskEvidenceSynthesisRiskEstimatePrecisionEstimate) String() string {
...
type RiskEvidenceSynthesisRiskEstimate struct {
	...
	DenominatorCount *types.Integer
	// The number of group members with the outcome of interest.
	NumeratorCount *types.Integer
}

func (s RiskEvidenceSynthesisRiskEstimate) String() string {
	buf, err := json.MarshalIndent(s, "", "  ")
	if err != nil {
		panic(err)
	}
...
func (s RiskEvidenceSynthesisSampleSize) String() string {
	buf, err := json.MarshalIndent(s, "", "  ")
	if err != nil {
		panic(err)
	}
...
func (s RiskEvidenceSynthesisCertaintyCertaintySubcomponent) String() string {
	buf, err := json.MarshalIndent(s, "", "  ")
	if err != nil {
		panic(err)
	}
...
func (s RiskEvidenceSynthesisCertainty) String() string {
	buf, err := json.MarshalIndent(s, "", "  ")
	if err != nil {
		panic(err)
	}
...
func (s RiskEvidenceSynthesis) String() string {
	buf, err := json.MarshalIndent(s, "", "  ")
	if err != nil {
		panic(err)
	}

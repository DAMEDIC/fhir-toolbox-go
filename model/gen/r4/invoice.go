...
func (r InvoiceLineItemPriceComponent) marshalJSON(w io.Writer) error {
	var err error
	_, err = w.Write([]byte("{"))
	if err != nil {
		return err
...
func (r *InvoiceLineItemPriceComponent) unmarshalJSON(d *json.Decoder) error {
	t, err := d.Token()
	if err != nil {
		return err
	}
	if t != json.Delim('{') {
		return fmt.Errorf("invalid token: %v, expected: '{' in InvoiceLineItemPriceComponent element", t)
	}
	for d.More() {
		t, err = d.Token()
		if err != nil {
		...
		f, ok := t.(string)
		if !ok {
			return fmt.Errorf("invalid token: %v, expected: field name in InvoiceLineItemPriceComponent element", t)
		}
		switch f {
		case "id":
			var v string
		...
		case "amount":
			...
			r.Amount = &v
		default:
			return fmt.Errorf("invalid field: %s in InvoiceLineItemPriceComponent", f)
		}
	}
	t, err = d.Token()
	if err != nil {
...
func (r InvoiceLineItemPriceComponent) Children(name ...string) fhirpath.Collection {
	var children fhirpath.Collection
	if len(name) == 0 || slices.Contains(name, "id") {
		if r.Id != nil {
			children = append(children, fhirpath.String(*r.Id))
...
func (r InvoiceLineItemPriceComponent) ToBoolean(explicit bool) (*fhirpath.Boolean, error) {
	return nil, errors.New("can not convert InvoiceLineItemPriceComponent to Boolean")
}
func (r InvoiceLineItemPriceComponent) ToString(explicit bool) (*fhirpath.String, error) {
	return nil, errors.New("can not convert InvoiceLineItemPriceComponent to String")
}
func (r InvoiceLineItemPriceComponent) ToInteger(explicit bool) (*fhirpath.Integer, error) {
	return nil, errors.New("can not convert InvoiceLineItemPriceComponent to Integer")
}
func (r InvoiceLineItemPriceComponent) ToDecimal(explicit bool) (*fhirpath.Decimal, error) {
	return nil, errors.New("can not convert InvoiceLineItemPriceComponent to Decimal")
}
func (r InvoiceLineItemPriceComponent) ToDate(explicit bool) (*fhirpath.Date, error) {
	return nil, errors.New("can not convert InvoiceLineItemPriceComponent to Date")
}
func (r InvoiceLineItemPriceComponent) ToTime(explicit bool) (*fhirpath.Time, error) {
	return nil, errors.New("can not convert InvoiceLineItemPriceComponent to Time")
}
func (r InvoiceLineItemPriceComponent) ToDateTime(explicit bool) (*fhirpath.DateTime, error) {
	return nil, errors.New("can not convert InvoiceLineItemPriceComponent to DateTime")
}
func (r InvoiceLineItemPriceComponent) ToQuantity(explicit bool) (*fhirpath.Quantity, error) {
	return nil, errors.New("can not convert InvoiceLineItemPriceComponent to Quantity")
}
func (r InvoiceLineItemPriceComponent) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) bool {

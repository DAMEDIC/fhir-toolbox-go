...
func (r AllergyIntolerance) MemSize() int {
	...
	s += (cap(r.Participant) - len(r.Participant)) * int(unsafe.Sizeof(AllergyIntoleranceParticipant{}))
...
func (r AllergyIntoleranceReaction) MemSize() int {
	...
	s += (cap(r.Manifestation) - len(r.Manifestation)) * int(unsafe.Sizeof(CodeableReference{}))

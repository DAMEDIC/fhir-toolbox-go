...
func (r Integer64) isElementDefinitionDefaultValue()             {}
...
func (r Availability) isElementDefinitionDefaultValue()          {}
func (r ExtendedContactDetail) isElementDefinitionDefaultValue() {}
...
func (r Integer64) isElementDefinitionFixed()             {}
...
func (r Availability) isElementDefinitionFixed()          {}
func (r ExtendedContactDetail) isElementDefinitionFixed() {}
...
func (r Integer64) isElementDefinitionPattern()             {}
...
func (r Availability) isElementDefinitionPattern()          {}
func (r ExtendedContactDetail) isElementDefinitionPattern() {}
...
func (r Integer64) isElementDefinitionMinValue()   {}
...
func (r Integer64) isElementDefinitionMaxValue()   {}
...
func (r Integer64) isElementDefinitionExampleValue()             {}
...
func (r Availability) isElementDefinitionExampleValue()          {}
func (r ExtendedContactDetail) isElementDefinitionExampleValue() {}
...
func (r ElementDefinitionBindingAdditional) String() string {
	buf, err := json.MarshalIndent(r, "", "  ")
	if err != nil {
		return "null"
	}
...
func (r ElementDefinition) marshalJSON(w io.Writer) error {
	...
	case Integer64:
		if v.Value != nil {
			...
			setComma = true
			_, err = w.Write([]byte("\"defaultValueInteger64\":"))
			if err != nil {
				return err
			}
			enc := json.NewEncoder(w)
		...
		if v.Id != nil || v.Extension != nil {
			...
			setComma = true
			_, err = w.Write([]byte("\"_defaultValueInteger64\":"))
			if err != nil {
				return err
			}
			err = p.marshalJSON(w)
	...
	case Availability:
		...
		setComma = true
		_, err = w.Write([]byte("\"defaultValueAvailability\":"))
		if err != nil {
			return err
		}
		enc := json.NewEncoder(w)
	...
	case ExtendedContactDetail:
		...
		setComma = true
		_, err = w.Write([]byte("\"defaultValueExtendedContactDetail\":"))
		if err != nil {
			return err
		}
		enc := json.NewEncoder(w)
	...
	case Integer64:
		if v.Value != nil {
			...
			setComma = true
			_, err = w.Write([]byte("\"fixedInteger64\":"))
			if err != nil {
				return err
			}
			enc := json.NewEncoder(w)
		...
		if v.Id != nil || v.Extension != nil {
			...
			setComma = true
			_, err = w.Write([]byte("\"_fixedInteger64\":"))
			if err != nil {
				return err
			}
			err = p.marshalJSON(w)
	...
	case Availability:
		...
		setComma = true
		_, err = w.Write([]byte("\"fixedAvailability\":"))
		if err != nil {
			return err
		}
		enc := json.NewEncoder(w)
	...
	case ExtendedContactDetail:
		...
		setComma = true
		_, err = w.Write([]byte("\"fixedExtendedContactDetail\":"))
		if err != nil {
			return err
		}
		enc := json.NewEncoder(w)
	...
	case Integer64:
		if v.Value != nil {
			...
			setComma = true
			_, err = w.Write([]byte("\"patternInteger64\":"))
			if err != nil {
				return err
			}
			enc := json.NewEncoder(w)
		...
		if v.Id != nil || v.Extension != nil {
			...
			setComma = true
			_, err = w.Write([]byte("\"_patternInteger64\":"))
			if err != nil {
				return err
			}
			err = p.marshalJSON(w)
	...
	case Availability:
		...
		setComma = true
		_, err = w.Write([]byte("\"patternAvailability\":"))
		if err != nil {
			return err
		}
		enc := json.NewEncoder(w)
	...
	case ExtendedContactDetail:
		...
		setComma = true
		_, err = w.Write([]byte("\"patternExtendedContactDetail\":"))
		if err != nil {
			return err
		}
		enc := json.NewEncoder(w)
	...
	case Integer64:
		if v.Value != nil {
			...
			setComma = true
			_, err = w.Write([]byte("\"minValueInteger64\":"))
			if err != nil {
				return err
			}
			enc := json.NewEncoder(w)
		...
		if v.Id != nil || v.Extension != nil {
			...
			setComma = true
			_, err = w.Write([]byte("\"_minValueInteger64\":"))
			if err != nil {
				return err
			}
			err = p.marshalJSON(w)
	...
	case Integer64:
		if v.Value != nil {
			...
			setComma = true
			_, err = w.Write([]byte("\"maxValueInteger64\":"))
			if err != nil {
				return err
			}
			enc := json.NewEncoder(w)
		...
		if v.Id != nil || v.Extension != nil {
			...
			setComma = true
			_, err = w.Write([]byte("\"_maxValueInteger64\":"))
			if err != nil {
				return err
			}
			err = p.marshalJSON(w)
	...
	if r.MustHaveValue != nil && r.MustHaveValue.Value != nil {
		if setComma {
			_, err = w.Write([]byte(","))
			if err != nil {
				return err
		...
		setComma = true
		_, err = w.Write([]byte("\"mustHaveValue\":"))
		if err != nil {
			return err
		}
		enc := json.NewEncoder(w)
		enc.SetEscapeHTML(false)
		err := enc.Encode(r.MustHaveValue)
		if err != nil {
			return err
		}
	}
	if r.MustHaveValue != nil && (r.MustHaveValue.Id != nil || r.MustHaveValue.Extension != nil) {
		p := primitiveElement{Id: r.MustHaveValue.Id, Extension: r.MustHaveValue.Extension}
		if setComma {
			_, err = w.Write([]byte(","))
			if err != nil {
				return err
		...
		setComma = true
		_, err = w.Write([]byte("\"_mustHaveValue\":"))
		if err != nil {
			return err
		}
		err = p.marshalJSON(w)
	...
	{
		anyValue := false
		for _, e := range r.ValueAlternatives {
			if e.Value != nil {
				anyValue = true
				break
			}
		...
		if anyValue {
			...
			setComma = true
			_, err = w.Write([]byte("\"valueAlternatives\":"))
			if err != nil {
				return err
			}
			enc := json.NewEncoder(w)
			enc.SetEscapeHTML(false)
			err := enc.Encode(r.ValueAlternatives)
			if err != nil {
				return err
			}
		}
		...
		if anyIdOrExtension {
			...
			setComma = true
			_, err = w.Write([]byte("\"_valueAlternatives\":"))
			if err != nil {
				return err
			}
			_, err = w.Write([]byte("["))
...
func (r ElementDefinitionConstraint) marshalJSON(w io.Writer) error {
	...
	if r.Suppress != nil && r.Suppress.Value != nil {
		if setComma {
			_, err = w.Write([]byte(","))
			if err != nil {
				return err
		...
		setComma = true
		_, err = w.Write([]byte("\"suppress\":"))
		if err != nil {
			return err
		}
		enc := json.NewEncoder(w)
		enc.SetEscapeHTML(false)
		err := enc.Encode(r.Suppress)
		if err != nil {
			return err
		}
	}
	if r.Suppress != nil && (r.Suppress.Id != nil || r.Suppress.Extension != nil) {
		p := primitiveElement{Id: r.Suppress.Id, Extension: r.Suppress.Extension}
		if setComma {
			_, err = w.Write([]byte(","))
			if err != nil {
				return err
...
func (r ElementDefinitionBindingAdditional) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	err := r.marshalJSON(&b)
	if err != nil {
		return nil, err
...
func (r ElementDefinitionBindingAdditional) marshalJSON(w io.Writer) error {
	var err error
	_, err = w.Write([]byte("{"))
	if err != nil {
		return err
	...
	if r.ShortDoco != nil && r.ShortDoco.Value != nil {
		if setComma {
			_, err = w.Write([]byte(","))
			if err != nil {
				return err
		...
		setComma = true
		_, err = w.Write([]byte("\"shortDoco\":"))
		if err != nil {
			return err
		}
		enc := json.NewEncoder(w)
		enc.SetEscapeHTML(false)
		err := enc.Encode(r.ShortDoco)
		if err != nil {
			return err
		}
	}
	if r.ShortDoco != nil && (r.ShortDoco.Id != nil || r.ShortDoco.Extension != nil) {
		p := primitiveElement{Id: r.ShortDoco.Id, Extension: r.ShortDoco.Extension}
		if setComma {
			_, err = w.Write([]byte(","))
			if err != nil {
				return err
	...
	if r.Any != nil && r.Any.Value != nil {
		...
		enc := json.NewEncoder(w)
		enc.SetEscapeHTML(false)
		err := enc.Encode(r.Any)
		if err != nil {
			return err
		}
	}
	if r.Any != nil && (r.Any.Id != nil || r.Any.Extension != nil) {
		p := primitiveElement{Id: r.Any.Id, Extension: r.Any.Extension}
		if setComma {
			_, err = w.Write([]byte(","))
			if err != nil {
				return err
...
func (r *ElementDefinition) unmarshalJSON(d *json.Decoder) error {
	...
	for d.More() {
		...
		case "defaultValueInteger64":
			...
			if r.DefaultValue != nil {
				r.DefaultValue = Integer64{
					Extension: r.DefaultValue.(Integer64).Extension,
					Id:        r.DefaultValue.(Integer64).Id,
					Value:     v.Value,
				}
			} else {
				r.DefaultValue = v
			}
		case "_defaultValueInteger64":
			var v primitiveElement
			err := v.unmarshalJSON(d)
			if err != nil {
				return err
			...
			if r.DefaultValue != nil {
				r.DefaultValue = Integer64{
					Extension: v.Extension,
					Id:        v.Id,
					Value:     r.DefaultValue.(Integer64).Value,
				}
			} else {
				r.DefaultValue = Integer64{
					Extension: v.Extension,
		...
		case "fixedInteger64":
			...
			if r.Fixed != nil {
				r.Fixed = Integer64{
					Extension: r.Fixed.(Integer64).Extension,
					Id:        r.Fixed.(Integer64).Id,
					Value:     v.Value,
				}
			} else {
				r.Fixed = v
			}
		case "_fixedInteger64":
			var v primitiveElement
			err := v.unmarshalJSON(d)
			if err != nil {
				return err
		...
		case "patternInteger64":
			...
			if r.Pattern != nil {
				r.Pattern = Integer64{
					Extension: r.Pattern.(Integer64).Extension,
					Id:        r.Pattern.(Integer64).Id,
					Value:     v.Value,
				}
			} else {
				r.Pattern = v
			}
		case "_patternInteger64":
			var v primitiveElement
			err := v.unmarshalJSON(d)
			if err != nil {
				return err
			...
			if r.Pattern != nil {
				r.Pattern = Integer64{
					Extension: v.Extension,
					Id:        v.Id,
					Value:     r.Pattern.(Integer64).Value,
				}
			} else {
				r.Pattern = Integer64{
					Extension: v.Extension,
		...
		case "minValueInteger64":
			...
			if r.MinValue != nil {
				r.MinValue = Integer64{
					Extension: r.MinValue.(Integer64).Extension,
					Id:        r.MinValue.(Integer64).Id,
					Value:     v.Value,
				}
			} else {
				r.MinValue = v
			}
		case "_minValueInteger64":
			var v primitiveElement
			err := v.unmarshalJSON(d)
			if err != nil {
				return err
			...
			if r.MinValue != nil {
				r.MinValue = Integer64{
					Extension: v.Extension,
					Id:        v.Id,
					Value:     r.MinValue.(Integer64).Value,
				}
			} else {
				r.MinValue = Integer64{
					Extension: v.Extension,
		...
		case "maxValueInteger64":
			...
			if r.MaxValue != nil {
				r.MaxValue = Integer64{
					Extension: r.MaxValue.(Integer64).Extension,
					Id:        r.MaxValue.(Integer64).Id,
					Value:     v.Value,
				}
			} else {
				r.MaxValue = v
			}
		case "_maxValueInteger64":
			var v primitiveElement
			err := v.unmarshalJSON(d)
			if err != nil {
				return err
			...
			if r.MaxValue != nil {
				r.MaxValue = Integer64{
					Extension: v.Extension,
					Id:        v.Id,
					Value:     r.MaxValue.(Integer64).Value,
				}
			} else {
				r.MaxValue = Integer64{
					Extension: v.Extension,
		...
		case "mustHaveValue":
			...
			if r.MustHaveValue == nil {
				r.MustHaveValue = &Boolean{}
			}
			r.MustHaveValue.Value = v.Value
		case "_mustHaveValue":
			var v primitiveElement
			err := v.unmarshalJSON(d)
			if err != nil {
			...
			r.MustHaveValue.Id = v.Id
			r.MustHaveValue.Extension = v.Extension
		case "valueAlternatives":
			...
			for i := 0; d.More(); i++ {
				...
				for len(r.ValueAlternatives) <= i {
					r.ValueAlternatives = append(r.ValueAlternatives, Canonical{})
				}
				r.ValueAlternatives[i].Value = v.Value
			}
			t, err = d.Token()
			if err != nil {
				return err
		...
		case "_valueAlternatives":
			...
			for i := 0; d.More(); i++ {
				...
				r.ValueAlternatives[i].Id = v.Id
				r.ValueAlternatives[i].Extension = v.Extension
			}
			t, err = d.Token()
			if err != nil {
				return err
...
func (r *ElementDefinitionConstraint) unmarshalJSON(d *json.Decoder) error {
	...
	for d.More() {
		...
		case "_suppress":
			...
			r.Suppress.Id = v.Id
			r.Suppress.Extension = v.Extension
		case "human":
			var v String
			err := d.Decode(&v)
			if err != nil {
...
func (r *ElementDefinitionBindingAdditional) unmarshalJSON(d *json.Decoder) error {
	t, err := d.Token()
	if err != nil {
		return err
	}
	if t != json.Delim('{') {
		return fmt.Errorf("invalid token: %v, expected: '{' in ElementDefinitionBindingAdditional element", t)
	}
	for d.More() {
		t, err = d.Token()
		if err != nil {
		...
		f, ok := t.(string)
		if !ok {
			return fmt.Errorf("invalid token: %v, expected: field name in ElementDefinitionBindingAdditional element", t)
		}
		switch f {
		case "id":
			var v string
		...
		case "_shortDoco":
			...
			r.ShortDoco.Id = v.Id
			r.ShortDoco.Extension = v.Extension
		case "usage":
			t, err = d.Token()
			if err != nil {
				return err
		...
		case "_any":
			...
			r.Any.Id = v.Id
			r.Any.Extension = v.Extension
		default:
			return fmt.Errorf("invalid field: %s in ElementDefinitionBindingAdditional", f)
		}
	}
	t, err = d.Token()
	if err != nil {
...
func (r ElementDefinition) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	case Integer64, *Integer64:
		err := e.EncodeElement(v, xml.StartElement{Name: xml.Name{Local: "defaultValueInteger64"}})
		if err != nil {
			return err
		}
	...
	case Availability, *Availability:
		err := e.EncodeElement(v, xml.StartElement{Name: xml.Name{Local: "defaultValueAvailability"}})
		if err != nil {
			return err
		}
	case ExtendedContactDetail, *ExtendedContactDetail:
		err := e.EncodeElement(v, xml.StartElement{Name: xml.Name{Local: "defaultValueExtendedContactDetail"}})
		if err != nil {
			return err
		}
	case Dosage, *Dosage:
	...
	case Integer64, *Integer64:
		err := e.EncodeElement(v, xml.StartElement{Name: xml.Name{Local: "fixedInteger64"}})
		if err != nil {
			return err
		}
	case Markdown, *Markdown:
	...
	case Availability, *Availability:
		err := e.EncodeElement(v, xml.StartElement{Name: xml.Name{Local: "fixedAvailability"}})
		if err != nil {
			return err
		}
	case ExtendedContactDetail, *ExtendedContactDetail:
		err := e.EncodeElement(v, xml.StartElement{Name: xml.Name{Local: "fixedExtendedContactDetail"}})
		if err != nil {
			return err
		}
	case Dosage, *Dosage:
	...
	case Integer64, *Integer64:
		err := e.EncodeElement(v, xml.StartElement{Name: xml.Name{Local: "patternInteger64"}})
		if err != nil {
			return err
		}
	case Markdown, *Markdown:
	...
	case Availability, *Availability:
		err := e.EncodeElement(v, xml.StartElement{Name: xml.Name{Local: "patternAvailability"}})
		if err != nil {
			return err
		}
	case ExtendedContactDetail, *ExtendedContactDetail:
		err := e.EncodeElement(v, xml.StartElement{Name: xml.Name{Local: "patternExtendedContactDetail"}})
		if err != nil {
			return err
		}
	case Dosage, *Dosage:
	...
	case Integer64, *Integer64:
		err := e.EncodeElement(v, xml.StartElement{Name: xml.Name{Local: "minValueInteger64"}})
		if err != nil {
			return err
		}
	case PositiveInt, *PositiveInt:
	...
	case Integer64, *Integer64:
		err := e.EncodeElement(v, xml.StartElement{Name: xml.Name{Local: "maxValueInteger64"}})
		if err != nil {
			return err
		}
	case PositiveInt, *PositiveInt:
	...
	err = e.EncodeElement(r.MustHaveValue, xml.StartElement{Name: xml.Name{Local: "mustHaveValue"}})
	if err != nil {
		return err
	}
	err = e.EncodeElement(r.ValueAlternatives, xml.StartElement{Name: xml.Name{Local: "valueAlternatives"}})
	if err != nil {
		return err
	}
...
func (r ElementDefinitionConstraint) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	err = e.EncodeElement(r.Suppress, xml.StartElement{Name: xml.Name{Local: "suppress"}})
	if err != nil {
		return err
	}
...
func (r ElementDefinitionBinding) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	err = e.EncodeElement(r.Additional, xml.StartElement{Name: xml.Name{Local: "additional"}})
	if err != nil {
		return err
	}
	err = e.EncodeToken(start.End())
...
func (r ElementDefinitionBindingAdditional) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	if r.Id != nil {
		start.Attr = append(start.Attr, xml.Attr{
			Name:  xml.Name{Local: "id"},
			Value: *r.Id,
	...
	err = e.EncodeElement(r.ShortDoco, xml.StartElement{Name: xml.Name{Local: "shortDoco"}})
	if err != nil {
		return err
	}
	...
	err = e.EncodeElement(r.Any, xml.StartElement{Name: xml.Name{Local: "any"}})
	if err != nil {
		return err
	}
	err = e.EncodeToken(start.End())
...
func (r ElementDefinition) Children(name ...string) fhirpath.Collection {
	...
	if len(name) == 0 || slices.Contains(name, "mustHaveValue") {
		if r.MustHaveValue != nil {
			children = append(children, *r.MustHaveValue)
		}
	}
	if len(name) == 0 || slices.Contains(name, "valueAlternatives") {
		for _, v := range r.ValueAlternatives {
			children = append(children, v)
		}
	}
...
func (r ElementDefinitionConstraint) Children(name ...string) fhirpath.Collection {
	...
	if len(name) == 0 || slices.Contains(name, "suppress") {
		if r.Suppress != nil {
			children = append(children, *r.Suppress)
		}
	}
...
func (r ElementDefinitionBinding) Children(name ...string) fhirpath.Collection {
	...
	if len(name) == 0 || slices.Contains(name, "additional") {
		for _, v := range r.Additional {
			children = append(children, v)
		}
	}
	return children
...
func (r ElementDefinitionBinding) TypeInfo() fhirpath.TypeInfo {
	return fhirpath.ClassInfo{
		Element: []fhirpath.ClassInfoElement{{
			...
			Name: "Additional",
			Type: "List<FHIR.ElementDefinitionBindingAdditional>",
		}},
		SimpleTypeInfo: fhirpath.SimpleTypeInfo{
			BaseType: fhirpath.TypeSpecifier{
				Name:      "DataType",
...
func (r ElementDefinitionBindingAdditional) Children(name ...string) fhirpath.Collection {
	var children fhirpath.Collection
	if len(name) == 0 || slices.Contains(name, "id") {
		if r.Id != nil {
			children = append(children, fhirpath.String(*r.Id))
	...
	if len(name) == 0 || slices.Contains(name, "shortDoco") {
		if r.ShortDoco != nil {
			children = append(children, *r.ShortDoco)
		}
	}
	...
	if len(name) == 0 || slices.Contains(name, "any") {
		if r.Any != nil {
			children = append(children, *r.Any)
		}
	}
	return children
}
func (r ElementDefinitionBindingAdditional) ToBoolean(explicit bool) (*fhirpath.Boolean, error) {
	return nil, errors.New("can not convert ElementDefinitionBindingAdditional to Boolean")
}
func (r ElementDefinitionBindingAdditional) ToString(explicit bool) (*fhirpath.String, error) {
	return nil, errors.New("can not convert ElementDefinitionBindingAdditional to String")
}
func (r ElementDefinitionBindingAdditional) ToInteger(explicit bool) (*fhirpath.Integer, error) {
	return nil, errors.New("can not convert ElementDefinitionBindingAdditional to Integer")
}
func (r ElementDefinitionBindingAdditional) ToDecimal(explicit bool) (*fhirpath.Decimal, error) {
	return nil, errors.New("can not convert ElementDefinitionBindingAdditional to Decimal")
}
func (r ElementDefinitionBindingAdditional) ToDate(explicit bool) (*fhirpath.Date, error) {
	return nil, errors.New("can not convert ElementDefinitionBindingAdditional to Date")
}
func (r ElementDefinitionBindingAdditional) ToTime(explicit bool) (*fhirpath.Time, error) {
	return nil, errors.New("can not convert ElementDefinitionBindingAdditional to Time")
}
func (r ElementDefinitionBindingAdditional) ToDateTime(explicit bool) (*fhirpath.DateTime, error) {
	return nil, errors.New("can not convert ElementDefinitionBindingAdditional to DateTime")
}
func (r ElementDefinitionBindingAdditional) ToQuantity(explicit bool) (*fhirpath.Quantity, error) {
	return nil, errors.New("can not convert ElementDefinitionBindingAdditional to Quantity")
}
func (r ElementDefinitionBindingAdditional) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) bool {
	var o ElementDefinitionBindingAdditional
	switch other := other.(type) {
	case ElementDefinitionBindingAdditional:
		o = other
	case *ElementDefinitionBindingAdditional:
		o = *other
	default:
...
func (r ElementDefinitionBindingAdditional) Equivalent(other fhirpath.Element, _noReverseTypeConversion ...bool) bool {
	var o ElementDefinitionBindingAdditional
	switch other := other.(type) {
	case ElementDefinitionBindingAdditional:
		o = other
...
func (r ElementDefinitionBindingAdditional) TypeInfo() fhirpath.TypeInfo {
	return fhirpath.ClassInfo{
		Element: []fhirpath.ClassInfoElement{{
			Name: "Id",
			Type: "FHIR.string",

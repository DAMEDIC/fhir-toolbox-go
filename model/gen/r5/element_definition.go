...
func (r ElementDefinitionBindingAdditional) ToBoolean(explicit bool) (fhirpath.Boolean, bool, error) {
	return false, false, errors.New("can not convert ElementDefinitionBindingAdditional to Boolean")
}
func (r ElementDefinitionBindingAdditional) ToString(explicit bool) (fhirpath.String, bool, error) {
	return "", false, errors.New("can not convert ElementDefinitionBindingAdditional to String")
}
...
func (r ElementDefinitionBindingAdditional) ToDate(explicit bool) (fhirpath.Date, bool, error) {
	return fhirpath.Date{}, false, errors.New("can not convert ElementDefinitionBindingAdditional to Date")
}
func (r ElementDefinitionBindingAdditional) ToTime(explicit bool) (fhirpath.Time, bool, error) {
	return fhirpath.Time{}, false, errors.New("can not convert ElementDefinitionBindingAdditional to Time")
}
func (r ElementDefinitionBindingAdditional) ToDateTime(explicit bool) (fhirpath.DateTime, bool, error) {
	return fhirpath.DateTime{}, false, errors.New("can not convert ElementDefinitionBindingAdditional to DateTime")
}
func (r ElementDefinitionBindingAdditional) ToQuantity(explicit bool) (fhirpath.Quantity, bool, error) {
	return fhirpath.Quantity{}, false, errors.New("can not convert ElementDefinitionBindingAdditional to Quantity")
}
func (r ElementDefinitionBindingAdditional) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {
...
func (r ElementDefinitionBindingAdditional) Equivalent(other fhirpath.Element, _noReverseTypeConversion ...bool) bool {
	o, ok := other.(ElementDefinitionBindingAdditional)
	if !ok {
		return false
	}
	r.Id = nil

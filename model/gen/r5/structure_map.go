...
type StructureMap struct {
	...
	VersionAlgorithm isStructureMapVersionAlgorithm
...
func (r String) isStructureMapVersionAlgorithm() {}
func (r Coding) isStructureMapVersionAlgorithm() {}
...
func (r Date) isStructureMapGroupRuleTargetParameterValue()     {}
func (r Time) isStructureMapGroupRuleTargetParameterValue()     {}
func (r DateTime) isStructureMapGroupRuleTargetParameterValue() {}
...
func (r StructureMap) MemSize() int {
	...
	s += (cap(r.Const) - len(r.Const)) * int(reflect.TypeOf(StructureMapConst{}).Size())
...
func (r StructureMapConst) String() string {
	buf, err := json.MarshalIndent(r, "", "  ")
	if err != nil {
		return "null"
	}
...
func (r StructureMapConst) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	err := r.marshalJSON(&b)
	if err != nil {
		return nil, err
...
func (r StructureMapConst) marshalJSON(w io.Writer) error {
	var err error
	_, err = w.Write([]byte("{"))
	if err != nil {
		return err
...
func (r StructureMapGroup) marshalJSON(w io.Writer) error {
	...
	if r.TypeMode != nil && r.TypeMode.Value != nil {
		if setComma {
			_, err = w.Write([]byte(","))
			if err != nil {
				return err
	...
	if r.TypeMode != nil && (r.TypeMode.Id != nil || r.TypeMode.Extension != nil) {
...
func (r *StructureMapConst) unmarshalJSON(d *json.Decoder) error {
	t, err := d.Token()
	if err != nil {
		return err
	}
	if t != json.Delim('{') {
		return fmt.Errorf("invalid token: %v, expected: '{' in StructureMapConst element", t)
	}
	for d.More() {
		t, err = d.Token()
		if err != nil {
		...
		f, ok := t.(string)
		if !ok {
			return fmt.Errorf("invalid token: %v, expected: field name in StructureMapConst element", t)
		}
		switch f {
		case "id":
			var v string
		...
		default:
			return fmt.Errorf("invalid field: %s in StructureMapConst", f)
		}
	}
	t, err = d.Token()
	if err != nil {
...
func (r StructureMap) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	err = e.EncodeElement(r.Const, xml.StartElement{Name: xml.Name{Local: "const"}})
	if err != nil {
		return err
	}
...
func (r StructureMapConst) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	if r.Id != nil {
		start.Attr = append(start.Attr, xml.Attr{
			Name:  xml.Name{Local: "id"},
			Value: *r.Id,
...
func (r StructureMap) Children(name ...string) fhirpath.Collection {
	...
	if len(name) == 0 || slices.Contains(name, "const") {
		for _, v := range r.Const {
			children = append(children, v)
		}
	}
...
func (r StructureMapConst) Children(name ...string) fhirpath.Collection {
	var children fhirpath.Collection
	if len(name) == 0 || slices.Contains(name, "id") {
		if r.Id != nil {
			children = append(children, fhirpath.String(*r.Id))

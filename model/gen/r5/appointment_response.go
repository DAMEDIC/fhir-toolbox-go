...
func (r AppointmentResponse) MemSize() int {
	...
	if r.ProposedNewTime != nil {
		s += r.ProposedNewTime.MemSize()
	}
	if r.Start != nil {
		s += r.Start.MemSize()
	}
	...
	if r.Recurring != nil {
		s += r.Recurring.MemSize()
	}
	if r.OccurrenceDate != nil {
		s += r.OccurrenceDate.MemSize()
	}
...
func (r AppointmentResponse) marshalJSON(w io.Writer) error {
	...
	if r.ProposedNewTime != nil && r.ProposedNewTime.Value != nil {
		if setComma {
			_, err = w.Write([]byte(","))
			if err != nil {
				return err
		...
		setComma = true
		_, err = w.Write([]byte("\"proposedNewTime\":"))
		if err != nil {
			return err
		}
		enc := json.NewEncoder(w)
		enc.SetEscapeHTML(false)
		err := enc.Encode(r.ProposedNewTime)
		if err != nil {
			return err
		}
	}
	if r.ProposedNewTime != nil && (r.ProposedNewTime.Id != nil || r.ProposedNewTime.Extension != nil) {
		p := primitiveElement{Id: r.ProposedNewTime.Id, Extension: r.ProposedNewTime.Extension}
		if setComma {
			_, err = w.Write([]byte(","))
			if err != nil {
				return err
		...
		setComma = true
		_, err = w.Write([]byte("\"_proposedNewTime\":"))
		if err != nil {
			return err
		}
		err = p.marshalJSON(w)
	...
	if r.Recurring != nil && r.Recurring.Value != nil {
		if setComma {
			_, err = w.Write([]byte(","))
			if err != nil {
				return err
		...
		setComma = true
		_, err = w.Write([]byte("\"recurring\":"))
		if err != nil {
			return err
		}
		enc := json.NewEncoder(w)
		enc.SetEscapeHTML(false)
		err := enc.Encode(r.Recurring)
		if err != nil {
			return err
		}
	}
	if r.Recurring != nil && (r.Recurring.Id != nil || r.Recurring.Extension != nil) {
		p := primitiveElement{Id: r.Recurring.Id, Extension: r.Recurring.Extension}
		if setComma {
			_, err = w.Write([]byte(","))
			if err != nil {
				return err
	...
	if r.OccurrenceDate != nil && r.OccurrenceDate.Value != nil {
		if setComma {
			_, err = w.Write([]byte(","))
			if err != nil {
				return err
	...
	if r.OccurrenceDate != nil && (r.OccurrenceDate.Id != nil || r.OccurrenceDate.Extension != nil) {
		p := primitiveElement{Id: r.OccurrenceDate.Id, Extension: r.OccurrenceDate.Extension}
		if setComma {
			_, err = w.Write([]byte(","))
			if err != nil {
				return err
...
func (r *AppointmentResponse) unmarshalJSON(d *json.Decoder) error {
	...
	for d.More() {
		...
		case "proposedNewTime":
			...
			if r.ProposedNewTime == nil {
				r.ProposedNewTime = &Boolean{}
			}
			r.ProposedNewTime.Value = v.Value
		case "_proposedNewTime":
			var v primitiveElement
			err := v.unmarshalJSON(d)
			if err != nil {
				return err
			...
			r.ProposedNewTime.Id = v.Id
			r.ProposedNewTime.Extension = v.Extension
		case "start":
			var v Instant
			err := d.Decode(&v)
			if err != nil {
		...
		case "_recurring":
			...
			r.Recurring.Id = v.Id
			r.Recurring.Extension = v.Extension
		case "occurrenceDate":
			var v Date
			err := d.Decode(&v)
			if err != nil {
			...
			r.OccurrenceDate.Value = v.Value
		case "_occurrenceDate":
			...
			r.OccurrenceDate.Id = v.Id
			r.OccurrenceDate.Extension = v.Extension
		case "recurrenceId":
			var v PositiveInt
			err := d.Decode(&v)
			if err != nil {
...
func (r AppointmentResponse) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	err = e.EncodeElement(r.ProposedNewTime, xml.StartElement{Name: xml.Name{Local: "proposedNewTime"}})
	if err != nil {
		return err
	}
	...
	err = e.EncodeElement(r.Recurring, xml.StartElement{Name: xml.Name{Local: "recurring"}})
	if err != nil {
		return err
	}
...
func (r AppointmentResponse) Children(name ...string) fhirpath.Collection {
	...
	if len(name) == 0 || slices.Contains(name, "proposedNewTime") {
		if r.ProposedNewTime != nil {
			children = append(children, *r.ProposedNewTime)
		}
	}
	...
	if len(name) == 0 || slices.Contains(name, "recurring") {
		if r.Recurring != nil {
			children = append(children, *r.Recurring)
		}
	}
	if len(name) == 0 || slices.Contains(name, "occurrenceDate") {
		if r.OccurrenceDate != nil {
			children = append(children, *r.OccurrenceDate)
		}
	}
...
func (r AppointmentResponse) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {

...
func (r Age) isFamilyMemberHistoryProcedurePerformed()      {}
func (r Range) isFamilyMemberHistoryProcedurePerformed()    {}
func (r Period) isFamilyMemberHistoryProcedurePerformed()   {}
func (r String) isFamilyMemberHistoryProcedurePerformed()   {}
func (r DateTime) isFamilyMemberHistoryProcedurePerformed() {}
...
func (r FamilyMemberHistoryParticipant) String() string {
	buf, err := json.MarshalIndent(r, "", "  ")
	if err != nil {
		return "null"
	}
...
func (r FamilyMemberHistoryProcedure) String() string {
	buf, err := json.MarshalIndent(r, "", "  ")
	if err != nil {
		return "null"
	}
...
func (r FamilyMemberHistoryParticipant) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	err := r.marshalJSON(&b)
	if err != nil {
		return nil, err
...
func (r FamilyMemberHistoryParticipant) marshalJSON(w io.Writer) error {
	var err error
	_, err = w.Write([]byte("{"))
	if err != nil {
		return err
...
func (r FamilyMemberHistoryProcedure) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	err := r.marshalJSON(&b)
	if err != nil {
		return nil, err
...
func (r FamilyMemberHistoryProcedure) marshalJSON(w io.Writer) error {
	var err error
	_, err = w.Write([]byte("{"))
	if err != nil {
		return err
...
func (r *FamilyMemberHistoryParticipant) unmarshalJSON(d *json.Decoder) error {
	t, err := d.Token()
	if err != nil {
		return err
	}
	if t != json.Delim('{') {
		return fmt.Errorf("invalid token: %v, expected: '{' in FamilyMemberHistoryParticipant element", t)
	}
	for d.More() {
		t, err = d.Token()
		if err != nil {
		...
		f, ok := t.(string)
		if !ok {
			return fmt.Errorf("invalid token: %v, expected: field name in FamilyMemberHistoryParticipant element", t)
		}
		switch f {
		case "id":
			var v string
		...
		case "actor":
			...
			r.Actor = v
		default:
			return fmt.Errorf("invalid field: %s in FamilyMemberHistoryParticipant", f)
		}
	}
	t, err = d.Token()
	if err != nil {
...
func (r *FamilyMemberHistoryProcedure) unmarshalJSON(d *json.Decoder) error {
	t, err := d.Token()
	if err != nil {
		return err
	}
	if t != json.Delim('{') {
		return fmt.Errorf("invalid token: %v, expected: '{' in FamilyMemberHistoryProcedure element", t)
	}
	for d.More() {
		t, err = d.Token()
		if err != nil {
		...
		f, ok := t.(string)
		if !ok {
			return fmt.Errorf("invalid token: %v, expected: field name in FamilyMemberHistoryProcedure element", t)
		}
		switch f {
		case "id":
			var v string
		...
		default:
			return fmt.Errorf("invalid field: %s in FamilyMemberHistoryProcedure", f)
		}
	}
	t, err = d.Token()
	if err != nil {
...
func (r FamilyMemberHistoryParticipant) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	if r.Id != nil {
...
func (r FamilyMemberHistoryProcedure) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	if r.Id != nil {
		start.Attr = append(start.Attr, xml.Attr{
			Name:  xml.Name{Local: "id"},
			Value: *r.Id,

...
func (r Quantity) isServiceRequestOrderDetailParameterValue()        {}
func (r Ratio) isServiceRequestOrderDetailParameterValue()           {}
func (r Range) isServiceRequestOrderDetailParameterValue()           {}
func (r Boolean) isServiceRequestOrderDetailParameterValue()         {}
func (r CodeableConcept) isServiceRequestOrderDetailParameterValue() {}
func (r String) isServiceRequestOrderDetailParameterValue()          {}
func (r Period) isServiceRequestOrderDetailParameterValue()          {}
...
func (r Markdown) isServiceRequestPatientInstructionInstruction()  {}
func (r Reference) isServiceRequestPatientInstructionInstruction() {}
...
func (r ServiceRequest) MemSize() int {
	...
	s += (cap(r.OrderDetail) - len(r.OrderDetail)) * int(reflect.TypeOf(ServiceRequestOrderDetail{}).Size())
	if r.Quantity != nil {
	...
	s += (cap(r.Location) - len(r.Location)) * int(reflect.TypeOf(CodeableReference{}).Size())
	...
	s += (cap(r.SupportingInfo) - len(r.SupportingInfo)) * int(reflect.TypeOf(CodeableReference{}).Size())
	...
	s += (cap(r.PatientInstruction) - len(r.PatientInstruction)) * int(reflect.TypeOf(ServiceRequestPatientInstruction{}).Size())
...
func (r ServiceRequestOrderDetail) MemSize() int {
	...
	s += (cap(r.Parameter) - len(r.Parameter)) * int(reflect.TypeOf(ServiceRequestOrderDetailParameter{}).Size())
	return s
}
...
func (r ServiceRequestOrderDetail) String() string {
	buf, err := json.MarshalIndent(r, "", "  ")
	if err != nil {
		return "null"
	}
...
func (r ServiceRequestOrderDetailParameter) String() string {
	buf, err := json.MarshalIndent(r, "", "  ")
	if err != nil {
		return "null"
	}
...
func (r ServiceRequestPatientInstruction) String() string {
	buf, err := json.MarshalIndent(r, "", "  ")
	if err != nil {
		return "null"
	}
...
func (r ServiceRequestOrderDetail) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	err := r.marshalJSON(&b)
	if err != nil {
		return nil, err
...
func (r ServiceRequestOrderDetail) marshalJSON(w io.Writer) error {
	var err error
	_, err = w.Write([]byte("{"))
	if err != nil {
		return err
	...
	if r.ParameterFocus != nil {
		...
		setComma = true
		_, err = w.Write([]byte("\"parameterFocus\":"))
		if err != nil {
			return err
		}
		err = r.ParameterFocus.marshalJSON(w)
		if err != nil {
			return err
		}
	}
...
func (r ServiceRequestOrderDetailParameter) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	err := r.marshalJSON(&b)
	if err != nil {
		return nil, err
...
func (r ServiceRequestOrderDetailParameter) marshalJSON(w io.Writer) error {
	var err error
	_, err = w.Write([]byte("{"))
	if err != nil {
		return err
...
func (r ServiceRequestPatientInstruction) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	err := r.marshalJSON(&b)
	if err != nil {
		return nil, err
...
func (r ServiceRequestPatientInstruction) marshalJSON(w io.Writer) error {
	var err error
	_, err = w.Write([]byte("{"))
	if err != nil {
		return err
	...
	case Markdown:
		if v.Value != nil {
			...
			setComma = true
			_, err = w.Write([]byte("\"instructionMarkdown\":"))
			if err != nil {
				return err
			}
			enc := json.NewEncoder(w)
		...
		if v.Id != nil || v.Extension != nil {
			...
			setComma = true
			_, err = w.Write([]byte("\"_instructionMarkdown\":"))
			if err != nil {
				return err
			}
			err = p.marshalJSON(w)
	...
	case Reference:
		...
		setComma = true
		_, err = w.Write([]byte("\"instructionReference\":"))
		if err != nil {
			return err
		}
		enc := json.NewEncoder(w)
...
func (r *ServiceRequestOrderDetail) unmarshalJSON(d *json.Decoder) error {
	t, err := d.Token()
	if err != nil {
		return err
	}
	if t != json.Delim('{') {
		return fmt.Errorf("invalid token: %v, expected: '{' in ServiceRequestOrderDetail element", t)
	}
	for d.More() {
		t, err = d.Token()
		if err != nil {
		...
		f, ok := t.(string)
		if !ok {
			return fmt.Errorf("invalid token: %v, expected: field name in ServiceRequestOrderDetail element", t)
		}
		switch f {
		case "id":
			var v string
		...
		default:
			return fmt.Errorf("invalid field: %s in ServiceRequestOrderDetail", f)
		}
	}
	t, err = d.Token()
	if err != nil {
...
func (r *ServiceRequestOrderDetailParameter) unmarshalJSON(d *json.Decoder) error {
	t, err := d.Token()
	if err != nil {
		return err
	}
	if t != json.Delim('{') {
		return fmt.Errorf("invalid token: %v, expected: '{' in ServiceRequestOrderDetailParameter element", t)
	}
	for d.More() {
		t, err = d.Token()
		if err != nil {
		...
		f, ok := t.(string)
		if !ok {
			return fmt.Errorf("invalid token: %v, expected: field name in ServiceRequestOrderDetailParameter element", t)
		}
		switch f {
		case "id":
			var v string
		...
		case "valuePeriod":
			...
			r.Value = v
		default:
			return fmt.Errorf("invalid field: %s in ServiceRequestOrderDetailParameter", f)
		}
	}
	t, err = d.Token()
	if err != nil {
...
func (r *ServiceRequestPatientInstruction) unmarshalJSON(d *json.Decoder) error {
	t, err := d.Token()
	if err != nil {
		return err
	}
	if t != json.Delim('{') {
		return fmt.Errorf("invalid token: %v, expected: '{' in ServiceRequestPatientInstruction element", t)
	}
	for d.More() {
		t, err = d.Token()
		if err != nil {
		...
		f, ok := t.(string)
		if !ok {
			return fmt.Errorf("invalid token: %v, expected: field name in ServiceRequestPatientInstruction element", t)
		}
		switch f {
		case "id":
			var v string
		...
		case "instructionMarkdown":
			...
			if r.Instruction != nil {
				r.Instruction = Markdown{
					Extension: r.Instruction.(Markdown).Extension,
					Id:        r.Instruction.(Markdown).Id,
					Value:     v.Value,
				}
			} else {
				r.Instruction = v
			}
		case "_instructionMarkdown":
			var v primitiveElement
			err := v.unmarshalJSON(d)
			if err != nil {
				return err
			...
			if r.Instruction != nil {
				r.Instruction = Markdown{
					Extension: v.Extension,
					Id:        v.Id,
					Value:     r.Instruction.(Markdown).Value,
				}
			} else {
				r.Instruction = Markdown{
					Extension: v.Extension,
		...
		case "instructionReference":
			...
			r.Instruction = v
		default:
			return fmt.Errorf("invalid field: %s in ServiceRequestPatientInstruction", f)
		}
	}
	t, err = d.Token()
	if err != nil {
...
func (r ServiceRequestOrderDetail) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	if r.Id != nil {
	...
	err = e.EncodeElement(r.ParameterFocus, xml.StartElement{Name: xml.Name{Local: "parameterFocus"}})
	if err != nil {
		return err
	}
...
func (r ServiceRequestOrderDetailParameter) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	if r.Id != nil {
		start.Attr = append(start.Attr, xml.Attr{
			Name:  xml.Name{Local: "id"},
			Value: *r.Id,
...
func (r ServiceRequestPatientInstruction) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	if r.Id != nil {
		start.Attr = append(start.Attr, xml.Attr{
			Name:  xml.Name{Local: "id"},
			Value: *r.Id,
	...
	case Markdown, *Markdown:
		err := e.EncodeElement(v, xml.StartElement{Name: xml.Name{Local: "instructionMarkdown"}})
		if err != nil {
			return err
		}
	case Reference, *Reference:
		err := e.EncodeElement(v, xml.StartElement{Name: xml.Name{Local: "instructionReference"}})
		if err != nil {
			return err
		}
	}
...
func (r *ServiceRequestPatientInstruction) UnmarshalXML(d *xml.Decoder, start xml.StartElement) error {
	...
	for {
		...
		case xml.StartElement:
			...
			case "instructionMarkdown":
				if r.Instruction != nil {
					return fmt.Errorf("multiple values for field \"Instruction\"")
				}
				var v Markdown
				err := d.DecodeElement(&v, &t)
				if err != nil {

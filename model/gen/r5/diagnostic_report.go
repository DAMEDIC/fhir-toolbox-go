...
func (r DiagnosticReport) MemSize() int {
	...
	s += (cap(r.SupportingInfo) - len(r.SupportingInfo)) * int(unsafe.Sizeof(DiagnosticReportSupportingInfo{}))
	for _, i := range r.Media {
		s += i.MemSize()
	}
	s += (cap(r.Media) - len(r.Media)) * int(unsafe.Sizeof(DiagnosticReportMedia{}))
	if r.Composition != nil {
		s += r.Composition.MemSize()
	}
	if r.Conclusion != nil {
...
func (r DiagnosticReportSupportingInfo) MemSize() int {
	s := int(unsafe.Sizeof(r))
	if r.Id != nil {
...
func (r DiagnosticReportSupportingInfo) String() string {
	buf, err := json.MarshalIndent(r, "", "  ")
	if err != nil {
		return "null"
	}
...
func (r DiagnosticReport) marshalJSON(w io.Writer) error {
	...
	if r.Composition != nil {
		...
		setComma = true
		_, err = w.Write([]byte("\"composition\":"))
		if err != nil {
			return err
		}
		err = r.Composition.marshalJSON(w)
		if err != nil {
			return err
		}
	}
...
func (r DiagnosticReportSupportingInfo) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	err := r.marshalJSON(&b)
	if err != nil {
		return nil, err
...
func (r DiagnosticReportSupportingInfo) marshalJSON(w io.Writer) error {
	var err error
	_, err = w.Write([]byte("{"))
	if err != nil {
		return err
...
func (r *DiagnosticReportSupportingInfo) unmarshalJSON(d *json.Decoder) error {
	t, err := d.Token()
	if err != nil {
		return err
	}
	if t != json.Delim('{') {
		return fmt.Errorf("invalid token: %v, expected: '{' in DiagnosticReportSupportingInfo element", t)
	}
	for d.More() {
		t, err = d.Token()
		if err != nil {
		...
		f, ok := t.(string)
		if !ok {
			return fmt.Errorf("invalid token: %v, expected: field name in DiagnosticReportSupportingInfo element", t)
		}
		switch f {
		case "id":
			var v string
		...
		case "reference":
			...
			r.Reference = v
		default:
			return fmt.Errorf("invalid field: %s in DiagnosticReportSupportingInfo", f)
		}
	}
	t, err = d.Token()
	if err != nil {
...
func (r DiagnosticReport) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	err = e.EncodeElement(r.Composition, xml.StartElement{Name: xml.Name{Local: "composition"}})
	if err != nil {
		return err
	}
...
func (r DiagnosticReportSupportingInfo) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	if r.Id != nil {
...
func (r DiagnosticReport) Children(name ...string) fhirpath.Collection {
	...
	if len(name) == 0 || slices.Contains(name, "composition") {
		if r.Composition != nil {
			children = append(children, *r.Composition)
		}
	}
...
func (r DiagnosticReport) ToBoolean(explicit bool) (*fhirpath.Boolean, error) {
	return nil, errors.New("can not convert DiagnosticReport to Boolean")
}
func (r DiagnosticReport) ToString(explicit bool) (*fhirpath.String, error) {
	return nil, errors.New("can not convert DiagnosticReport to String")
}
func (r DiagnosticReport) ToInteger(explicit bool) (*fhirpath.Integer, error) {
	return nil, errors.New("can not convert DiagnosticReport to Integer")
}
func (r DiagnosticReport) ToDecimal(explicit bool) (*fhirpath.Decimal, error) {
	return nil, errors.New("can not convert DiagnosticReport to Decimal")
}
func (r DiagnosticReport) ToDate(explicit bool) (*fhirpath.Date, error) {
	return nil, errors.New("can not convert DiagnosticReport to Date")
}
func (r DiagnosticReport) ToTime(explicit bool) (*fhirpath.Time, error) {
	return nil, errors.New("can not convert DiagnosticReport to Time")
}
func (r DiagnosticReport) ToDateTime(explicit bool) (*fhirpath.DateTime, error) {
	return nil, errors.New("can not convert DiagnosticReport to DateTime")
}
...
func (r DiagnosticReportSupportingInfo) Children(name ...string) fhirpath.Collection {
	var children fhirpath.Collection
	if len(name) == 0 || slices.Contains(name, "id") {
		if r.Id != nil {
...
func (r DiagnosticReportSupportingInfo) ToBoolean(explicit bool) (*fhirpath.Boolean, error) {
	return nil, errors.New("can not convert DiagnosticReportSupportingInfo to Boolean")
}
func (r DiagnosticReportSupportingInfo) ToString(explicit bool) (*fhirpath.String, error) {
	return nil, errors.New("can not convert DiagnosticReportSupportingInfo to String")
}
func (r DiagnosticReportSupportingInfo) ToInteger(explicit bool) (*fhirpath.Integer, error) {
	return nil, errors.New("can not convert DiagnosticReportSupportingInfo to Integer")
}
func (r DiagnosticReportSupportingInfo) ToDecimal(explicit bool) (*fhirpath.Decimal, error) {
	return nil, errors.New("can not convert DiagnosticReportSupportingInfo to Decimal")
}
func (r DiagnosticReportSupportingInfo) ToDate(explicit bool) (*fhirpath.Date, error) {
	return nil, errors.New("can not convert DiagnosticReportSupportingInfo to Date")
}
func (r DiagnosticReportSupportingInfo) ToTime(explicit bool) (*fhirpath.Time, error) {
	return nil, errors.New("can not convert DiagnosticReportSupportingInfo to Time")
}
func (r DiagnosticReportSupportingInfo) ToDateTime(explicit bool) (*fhirpath.DateTime, error) {
	return nil, errors.New("can not convert DiagnosticReportSupportingInfo to DateTime")
}
...
func (r DiagnosticReportMedia) ToBoolean(explicit bool) (*fhirpath.Boolean, error) {
	return nil, errors.New("can not convert DiagnosticReportMedia to Boolean")
}
func (r DiagnosticReportMedia) ToString(explicit bool) (*fhirpath.String, error) {
	return nil, errors.New("can not convert DiagnosticReportMedia to String")
}
func (r DiagnosticReportMedia) ToInteger(explicit bool) (*fhirpath.Integer, error) {
	return nil, errors.New("can not convert DiagnosticReportMedia to Integer")
}
func (r DiagnosticReportMedia) ToDecimal(explicit bool) (*fhirpath.Decimal, error) {
	return nil, errors.New("can not convert DiagnosticReportMedia to Decimal")
}
func (r DiagnosticReportMedia) ToDate(explicit bool) (*fhirpath.Date, error) {
	return nil, errors.New("can not convert DiagnosticReportMedia to Date")
}
func (r DiagnosticReportMedia) ToTime(explicit bool) (*fhirpath.Time, error) {
	return nil, errors.New("can not convert DiagnosticReportMedia to Time")
}
func (r DiagnosticReportMedia) ToDateTime(explicit bool) (*fhirpath.DateTime, error) {
	return nil, errors.New("can not convert DiagnosticReportMedia to DateTime")
}

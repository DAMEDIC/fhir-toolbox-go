...
func (r ActivityDefinition) MemSize() int {
	...
	s += (cap(r.SpecimenRequirement) - len(r.SpecimenRequirement)) * int(reflect.TypeOf(Canonical{}).Size())
	for _, i := range r.ObservationRequirement {
		s += i.MemSize()
	}
	s += (cap(r.ObservationRequirement) - len(r.ObservationRequirement)) * int(reflect.TypeOf(Canonical{}).Size())
	for _, i := range r.ObservationResultRequirement {
		s += i.MemSize()
	}
	s += (cap(r.ObservationResultRequirement) - len(r.ObservationResultRequirement)) * int(reflect.TypeOf(Canonical{}).Size())
	if r.Transform != nil {
...
func (r ActivityDefinition) marshalJSON(w io.Writer) error {
	...
	}
	{
		...
		if anyValue {
			...
			enc := json.NewEncoder(w)
			enc.SetEscapeHTML(false)
			err := enc.Encode(r.SpecimenRequirement)
			if err != nil {
				return err
			}
		}
		...
		if anyIdOrExtension {
			...
			setComma = true
			_, err = w.Write([]byte("\"_specimenRequirement\":"))
			if err != nil {
				return err
			}
			_, err = w.Write([]byte("["))
	...
	}
	{
		...
		if anyValue {
			...
			enc := json.NewEncoder(w)
			enc.SetEscapeHTML(false)
			err := enc.Encode(r.ObservationRequirement)
			if err != nil {
				return err
			}
		}
		...
		if anyIdOrExtension {
			...
			setComma = true
			_, err = w.Write([]byte("\"_observationRequirement\":"))
			if err != nil {
				return err
			}
			_, err = w.Write([]byte("["))
	...
	}
	{
		...
		if anyValue {
			...
			enc := json.NewEncoder(w)
			enc.SetEscapeHTML(false)
			err := enc.Encode(r.ObservationResultRequirement)
			if err != nil {
				return err
			}
		}
		...
		if anyIdOrExtension {
			...
			setComma = true
			_, err = w.Write([]byte("\"_observationResultRequirement\":"))
			if err != nil {
				return err
			}
			_, err = w.Write([]byte("["))
	...
	for d.More() {
		...
		case "specimenRequirement":
			...
			for i := 0; d.More(); i++ {
				...
				for len(r.SpecimenRequirement) <= i {
					r.SpecimenRequirement = append(r.SpecimenRequirement, Canonical{})
				}
				r.SpecimenRequirement[i].Value = v.Value
			}
			t, err = d.Token()
			if err != nil {
				return err
		...
		case "_specimenRequirement":
			...
			for i := 0; d.More(); i++ {
				...
				r.SpecimenRequirement[i].Id = v.Id
				r.SpecimenRequirement[i].Extension = v.Extension
			}
			t, err = d.Token()
			if err != nil {
				return err
		...
		case "observationRequirement":
			...
			for i := 0; d.More(); i++ {
				...
				for len(r.ObservationRequirement) <= i {
					r.ObservationRequirement = append(r.ObservationRequirement, Canonical{})
				}
				r.ObservationRequirement[i].Value = v.Value
			}
			t, err = d.Token()
			if err != nil {
				return err
		...
		case "_observationRequirement":
			...
			for i := 0; d.More(); i++ {
				...
				r.ObservationRequirement[i].Id = v.Id
				r.ObservationRequirement[i].Extension = v.Extension
			}
			t, err = d.Token()
			if err != nil {
				return err
		...
		case "observationResultRequirement":
			...
			for i := 0; d.More(); i++ {
				...
				for len(r.ObservationResultRequirement) <= i {
					r.ObservationResultRequirement = append(r.ObservationResultRequirement, Canonical{})
				}
				r.ObservationResultRequirement[i].Value = v.Value
			}
			t, err = d.Token()
			if err != nil {
				return err
		...
		case "_observationResultRequirement":
			t, err = d.Token()
			if err != nil {
				return err
			}
			...
			for i := 0; d.More(); i++ {
				...
				r.ObservationResultRequirement[i].Id = v.Id
				r.ObservationResultRequirement[i].Extension = v.Extension
			}
			t, err = d.Token()
			if err != nil {
				return err

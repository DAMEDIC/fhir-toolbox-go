...
func (r String) isChargeItemDefinitionVersionAlgorithm() {}
func (r Coding) isChargeItemDefinitionVersionAlgorithm() {}
...
func (r ChargeItemDefinitionApplicability) marshalJSON(w io.Writer) error {
	...
	if r.RelatedArtifact != nil {
		...
		err = r.RelatedArtifact.marshalJSON(w)
		if err != nil {
			return err
		}
	}
...
func (r ChargeItemDefinitionApplicability) Children(name ...string) fhirpath.Collection {
	...
	if len(name) == 0 || slices.Contains(name, "relatedArtifact") {
		if r.RelatedArtifact != nil {
			children = append(children, *r.RelatedArtifact)
		}
	}
	return children
}

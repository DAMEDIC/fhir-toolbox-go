...
type CompartmentDefinition struct {
	...
	VersionAlgorithm isCompartmentDefinitionVersionAlgorithm
...
type isCompartmentDefinitionVersionAlgorithm interface {
	model.Element
	isCompartmentDefinitionVersionAlgorithm()
}

func (r String) isCompartmentDefinitionVersionAlgorithm() {}
func (r Coding) isCompartmentDefinitionVersionAlgorithm() {}
...
func (r CompartmentDefinitionResource) MemSize() int {
	...
	if r.StartParam != nil {
		s += r.StartParam.MemSize()
	}
	if r.EndParam != nil {
		s += r.EndParam.MemSize()
	}
	return s
}
...
func (r CompartmentDefinitionResource) marshalJSON(w io.Writer) error {
	...
	if r.StartParam != nil && r.StartParam.Value != nil {
		if setComma {
			_, err = w.Write([]byte(","))
			if err != nil {
				return err
		...
		setComma = true
		_, err = w.Write([]byte("\"startParam\":"))
		if err != nil {
			return err
		}
		enc := json.NewEncoder(w)
		enc.SetEscapeHTML(false)
		err := enc.Encode(r.StartParam)
		if err != nil {
			return err
		}
	}
	if r.StartParam != nil && (r.StartParam.Id != nil || r.StartParam.Extension != nil) {
		p := primitiveElement{Id: r.StartParam.Id, Extension: r.StartParam.Extension}
		if setComma {
			_, err = w.Write([]byte(","))
			if err != nil {
				return err
		...
		setComma = true
		_, err = w.Write([]byte("\"_startParam\":"))
		if err != nil {
			return err
		}
		err = p.marshalJSON(w)
	...
	if r.EndParam != nil && r.EndParam.Value != nil {
		if setComma {
			_, err = w.Write([]byte(","))
			if err != nil {
				return err
		...
		setComma = true
		_, err = w.Write([]byte("\"endParam\":"))
		if err != nil {
			return err
		}
		enc := json.NewEncoder(w)
		enc.SetEscapeHTML(false)
		err := enc.Encode(r.EndParam)
		if err != nil {
			return err
		}
	}
	if r.EndParam != nil && (r.EndParam.Id != nil || r.EndParam.Extension != nil) {
		p := primitiveElement{Id: r.EndParam.Id, Extension: r.EndParam.Extension}
		if setComma {
			_, err = w.Write([]byte(","))
			if err != nil {
				return err
...
func (r *CompartmentDefinitionResource) unmarshalJSON(d *json.Decoder) error {
	...
	for d.More() {
		...
		case "_startParam":
			...
			r.StartParam.Id = v.Id
			r.StartParam.Extension = v.Extension
		case "endParam":
			var v Uri
			err := d.Decode(&v)
			if err != nil {
		...
		case "_endParam":
			...
			r.EndParam.Id = v.Id
			r.EndParam.Extension = v.Extension
		default:
...
func (r CompartmentDefinitionResource) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	err = e.EncodeElement(r.StartParam, xml.StartElement{Name: xml.Name{Local: "startParam"}})
	if err != nil {
		return err
	}
	err = e.EncodeElement(r.EndParam, xml.StartElement{Name: xml.Name{Local: "endParam"}})
	if err != nil {
		return err
	}
	err = e.EncodeToken(start.End())
...
func (r CompartmentDefinitionResource) Children(name ...string) fhirpath.Collection {
	...
	if len(name) == 0 || slices.Contains(name, "startParam") {
		if r.StartParam != nil {
			children = append(children, *r.StartParam)
		}
	}
	if len(name) == 0 || slices.Contains(name, "endParam") {
		if r.EndParam != nil {
			children = append(children, *r.EndParam)
		}
	}
	return children
}

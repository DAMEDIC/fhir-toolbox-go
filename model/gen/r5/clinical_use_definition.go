...
func (r ClinicalUseDefinitionContraindicationOtherTherapy) marshalJSON(w io.Writer) error {
	...
	setComma = true
	_, err = w.Write([]byte("\"treatment\":"))
	if err != nil {
		return err
	}
	err = r.Treatment.marshalJSON(w)
	if err != nil {
		return err
	}
	_, err = w.Write([]byte("}"))
...
func (r ClinicalUseDefinitionContraindicationOtherTherapy) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	err = e.EncodeElement(r.Treatment, xml.StartElement{Name: xml.Name{Local: "treatment"}})
	if err != nil {
		return err
	}
	err = e.EncodeToken(start.End())
...
func (r ClinicalUseDefinitionContraindication) TypeInfo() fhirpath.TypeInfo {
	return fhirpath.ClassInfo{
		Element: []fhirpath.ClassInfoElement{{
			...
			Name: "OtherTherapy",
			Type: "List<FHIR.ClinicalUseDefinitionContraindicationOtherTherapy>",
		}},
		SimpleTypeInfo: fhirpath.SimpleTypeInfo{
			BaseType: fhirpath.TypeSpecifier{
				Name:      "DataType",
...
func (r ClinicalUseDefinitionContraindicationOtherTherapy) Children(name ...string) fhirpath.Collection {
	...
	if len(name) == 0 || slices.Contains(name, "treatment") {
		children = append(children, r.Treatment)
	}
	return children
}
...
func (r ClinicalUseDefinitionInteraction) TypeInfo() fhirpath.TypeInfo {
	return fhirpath.ClassInfo{
		Element: []fhirpath.ClassInfoElement{{
			...
			Name: "Interactant",
			Type: "List<FHIR.ClinicalUseDefinitionInteractionInteractant>",
		}, {
			Name: "Type",
			Type: "FHIR.CodeableConcept",
		}, {

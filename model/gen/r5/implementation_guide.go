...
func (r String) isImplementationGuideVersionAlgorithm() {}
func (r Coding) isImplementationGuideVersionAlgorithm() {}
...
func (r Url) isImplementationGuideDefinitionPageSource()      {}
func (r String) isImplementationGuideDefinitionPageSource()   {}
func (r Markdown) isImplementationGuideDefinitionPageSource() {}
...
func (r ImplementationGuideDefinitionResource) marshalJSON(w io.Writer) error {
	...
	if r.IsExample != nil && r.IsExample.Value != nil {
		if setComma {
			_, err = w.Write([]byte(","))
			if err != nil {
				return err
		...
		setComma = true
		_, err = w.Write([]byte("\"isExample\":"))
		if err != nil {
			return err
		}
		enc := json.NewEncoder(w)
		enc.SetEscapeHTML(false)
		err := enc.Encode(r.IsExample)
		if err != nil {
			return err
		}
	}
	if r.IsExample != nil && (r.IsExample.Id != nil || r.IsExample.Extension != nil) {
		p := primitiveElement{Id: r.IsExample.Id, Extension: r.IsExample.Extension}
		if setComma {
			_, err = w.Write([]byte(","))
			if err != nil {
				return err
...
func (r ImplementationGuideDefinitionPage) marshalJSON(w io.Writer) error {
	...
	case Markdown:
		if v.Value != nil {
			...
			setComma = true
			_, err = w.Write([]byte("\"sourceMarkdown\":"))
			if err != nil {
				return err
			}
			enc := json.NewEncoder(w)
		...
		if v.Id != nil || v.Extension != nil {
			...
			setComma = true
			_, err = w.Write([]byte("\"_sourceMarkdown\":"))
			if err != nil {
				return err
			}
			err = p.marshalJSON(w)
...
func (r *ImplementationGuideDefinitionResource) unmarshalJSON(d *json.Decoder) error {
	...
	for d.More() {
		...
		case "_isExample":
			...
			r.IsExample.Id = v.Id
			r.IsExample.Extension = v.Extension
		case "profile":
			t, err = d.Token()
			if err != nil {
				return err
...
func (r *ImplementationGuideDefinitionPage) unmarshalJSON(d *json.Decoder) error {
	...
	for d.More() {
		...
		case "sourceUrl":
			...
			if r.Source != nil {
				r.Source = Url{
					Extension: r.Source.(Url).Extension,
					Id:        r.Source.(Url).Id,
					Value:     v.Value,
				}
			} else {
		...
		case "sourceMarkdown":
			...
			if r.Source != nil {
				r.Source = Markdown{
					Extension: r.Source.(Markdown).Extension,
					Id:        r.Source.(Markdown).Id,
					Value:     v.Value,
				}
			} else {
				r.Source = v
			}
		case "_sourceMarkdown":
			var v primitiveElement
			err := v.unmarshalJSON(d)
			if err != nil {
				return err
...
func (r ImplementationGuideDefinitionResource) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	err = e.EncodeElement(r.IsExample, xml.StartElement{Name: xml.Name{Local: "isExample"}})
	if err != nil {
		return err
	}
	err = e.EncodeElement(r.Profile, xml.StartElement{Name: xml.Name{Local: "profile"}})
...
func (r ImplementationGuideDefinitionPage) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	switch v := r.Source.(type) {
	case Url, *Url:
		err := e.EncodeElement(v, xml.StartElement{Name: xml.Name{Local: "sourceUrl"}})
		if err != nil {
			return err
		}
	case String, *String:
	...
	case Markdown, *Markdown:
		err := e.EncodeElement(v, xml.StartElement{Name: xml.Name{Local: "sourceMarkdown"}})
		if err != nil {
			return err
		}
	}
...
func (r ImplementationGuideDefinition) TypeInfo() fhirpath.TypeInfo {
	return fhirpath.ClassInfo{
		Element: []fhirpath.ClassInfoElement{{
			...
			Name: "Grouping",
			Type: "List<FHIR.ImplementationGuideDefinitionGrouping>",
		}, {
			Name: "Resource",
			Type: "List<FHIR.ImplementationGuideDefinitionResource>",
		}, {
			Name: "Page",
			Type: "FHIR.ImplementationGuideDefinitionPage",
		}, {
			Name: "Parameter",
			Type: "List<FHIR.ImplementationGuideDefinitionParameter>",
		}, {
			Name: "Template",
			Type: "List<FHIR.ImplementationGuideDefinitionTemplate>",
		}},
		SimpleTypeInfo: fhirpath.SimpleTypeInfo{
			BaseType: fhirpath.TypeSpecifier{
				Name:      "DataType",
...
func (r ImplementationGuideDefinitionResource) Children(name ...string) fhirpath.Collection {
	...
	if len(name) == 0 || slices.Contains(name, "isExample") {
		if r.IsExample != nil {
			children = append(children, *r.IsExample)
		}
	}
	if len(name) == 0 || slices.Contains(name, "profile") {
...
func (r ImplementationGuideDefinitionPage) TypeInfo() fhirpath.TypeInfo {
	return fhirpath.ClassInfo{
		Element: []fhirpath.ClassInfoElement{{
			...
			Name: "Page",
			Type: "List<FHIR.ImplementationGuideDefinitionPage>",
		}},
		SimpleTypeInfo: fhirpath.SimpleTypeInfo{
			BaseType: fhirpath.TypeSpecifier{
				Name:      "DataType",
...
func (r ImplementationGuideManifest) TypeInfo() fhirpath.TypeInfo {
	return fhirpath.ClassInfo{
		Element: []fhirpath.ClassInfoElement{{
			...
			Name: "Resource",
			Type: "List<FHIR.ImplementationGuideManifestResource>",
		}, {
			Name: "Page",
			Type: "List<FHIR.ImplementationGuideManifestPage>",
		}, {
			Name: "Image",

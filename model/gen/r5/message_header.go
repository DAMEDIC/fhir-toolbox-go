...
func (r Canonical) isMessageHeaderEvent() {}
...
func (r Url) isMessageHeaderDestinationEndpoint()       {}
func (r Reference) isMessageHeaderDestinationEndpoint() {}
...
func (r Url) isMessageHeaderSourceEndpoint()       {}
func (r Reference) isMessageHeaderSourceEndpoint() {}
...
func (r MessageHeader) marshalJSON(w io.Writer) error {
	...
	case Canonical:
		if v.Value != nil {
			...
			setComma = true
			_, err = w.Write([]byte("\"eventCanonical\":"))
			if err != nil {
				return err
			}
			var b bytes.Buffer
		...
		if v.Id != nil || v.Extension != nil {
			...
			setComma = true
			_, err = w.Write([]byte("\"_eventCanonical\":"))
			if err != nil {
				return err
			}
			err = p.marshalJSON(w)
...
func (r MessageHeaderDestination) marshalJSON(w io.Writer) error {
	...
	case Url:
		if v.Value != nil {
			...
			setComma = true
			_, err = w.Write([]byte("\"endpointUrl\":"))
			if err != nil {
				return err
			}
			var b bytes.Buffer
		...
		if v.Id != nil || v.Extension != nil {
			...
			setComma = true
			_, err = w.Write([]byte("\"_endpointUrl\":"))
			if err != nil {
				return err
			}
			err = p.marshalJSON(w)
	...
	case Reference:
		...
		setComma = true
		_, err = w.Write([]byte("\"endpointReference\":"))
		if err != nil {
			return err
		}
		var b bytes.Buffer
...
func (r *MessageHeader) unmarshalJSON(d *json.Decoder) error {
	...
	for d.More() {
		...
		case "eventCanonical":
			...
			if r.Event != nil {
				r.Event = Canonical{
					Extension: r.Event.(Canonical).Extension,
					Id:        r.Event.(Canonical).Id,
					Value:     v.Value,
				}
			} else {
				r.Event = v
			}
		case "_eventCanonical":
			var v primitiveElement
			err := v.unmarshalJSON(d)
			if err != nil {
				return err
...
func (r *MessageHeaderDestination) unmarshalJSON(d *json.Decoder) error {
	...
	for d.More() {
		...
		case "endpointUrl":
			...
			if r.Endpoint != nil {
				r.Endpoint = Url{
					Extension: r.Endpoint.(Url).Extension,
					Id:        r.Endpoint.(Url).Id,
					Value:     v.Value,
				}
			} else {
				r.Endpoint = v
...
func (r MessageHeader) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	case Canonical, *Canonical:
		err := e.EncodeElement(v, xml.StartElement{Name: xml.Name{Local: "eventCanonical"}})
		if err != nil {
			return err
		}
	}
...
func (r MessageHeaderDestination) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	switch v := r.Endpoint.(type) {
	case Url, *Url:
		err := e.EncodeElement(v, xml.StartElement{Name: xml.Name{Local: "endpointUrl"}})
		if err != nil {
			return err
		}
	case Reference, *Reference:
		err := e.EncodeElement(v, xml.StartElement{Name: xml.Name{Local: "endpointReference"}})
		if err != nil {
			return err
		}
	}
...
func (r *MessageHeaderDestination) UnmarshalXML(d *xml.Decoder, start xml.StartElement) error {
	...
	for {
		...
		case xml.StartElement:
			...
			case "endpointUrl":
				if r.Endpoint != nil {
					return fmt.Errorf("multiple values for field \"Endpoint\"")
				}
				var v Url
				err := d.DecodeElement(&v, &t)
				if err != nil {

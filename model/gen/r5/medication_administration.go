...
func (r DateTime) isMedicationAdministrationOccurence() {}
func (r Period) isMedicationAdministrationOccurence()   {}
func (r Timing) isMedicationAdministrationOccurence()   {}
...
func (r MedicationAdministration) marshalJSON(w io.Writer) error {
	...
	case DateTime:
		if v.Value != nil {
			...
			setComma = true
			_, err = w.Write([]byte("\"occurenceDateTime\":"))
			if err != nil {
				return err
			}
			enc := json.NewEncoder(w)
		...
		if v.Id != nil || v.Extension != nil {
			...
			setComma = true
			_, err = w.Write([]byte("\"_occurenceDateTime\":"))
			if err != nil {
				return err
			}
			err = p.marshalJSON(w)
	...
	case Period:
		...
		setComma = true
		_, err = w.Write([]byte("\"occurencePeriod\":"))
		if err != nil {
			return err
		}
		enc := json.NewEncoder(w)
	...
	case Timing:
		...
		setComma = true
		_, err = w.Write([]byte("\"occurenceTiming\":"))
		if err != nil {
			return err
		}
		enc := json.NewEncoder(w)
...
func (r *MedicationAdministration) unmarshalJSON(d *json.Decoder) error {
	...
	for d.More() {
		...
		case "occurenceDateTime":
			...
			if r.Occurence != nil {
				r.Occurence = DateTime{
					Extension: r.Occurence.(DateTime).Extension,
					Id:        r.Occurence.(DateTime).Id,
					Value:     v.Value,
				}
			} else {
				r.Occurence = v
		...
		case "_occurenceDateTime":
			...
			if r.Occurence != nil {
				r.Occurence = DateTime{
					...
					Id:        v.Id,
					Value:     r.Occurence.(DateTime).Value,
				}
			} else {
				r.Occurence = DateTime{
					Extension: v.Extension,
...
func (r MedicationAdministration) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	case DateTime, *DateTime:
		err := e.EncodeElement(v, xml.StartElement{Name: xml.Name{Local: "occurenceDateTime"}})
		if err != nil {
			return err
		}
	case Period, *Period:
		err := e.EncodeElement(v, xml.StartElement{Name: xml.Name{Local: "occurencePeriod"}})
		if err != nil {
			return err
		}
	case Timing, *Timing:
		err := e.EncodeElement(v, xml.StartElement{Name: xml.Name{Local: "occurenceTiming"}})
		if err != nil {
			return err
		}
	}
...
func (r *MedicationAdministration) UnmarshalXML(d *xml.Decoder, start xml.StartElement) error {
	...
	for {
		...
		case xml.StartElement:
			...
			case "occurenceDateTime":
				if r.Occurence != nil {
					return fmt.Errorf("multiple values for field \"Occurence\"")
				}
				var v DateTime
				err := d.DecodeElement(&v, &t)
				if err != nil {
...
func (r MedicationAdministration) Children(name ...string) fhirpath.Collection {
	...
	if len(name) == 0 || slices.Contains(name, "occurence") {
		children = append(children, r.Occurence)
	}
...
func (r MedicationAdministration) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {
...
func (r MedicationAdministrationPerformer) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {
...
func (r MedicationAdministrationDosage) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {

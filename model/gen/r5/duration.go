...
func (r Duration) marshalJSON(w io.Writer) error {
	var err error
	_, err = w.Write([]byte("{"))
	if err != nil {
		return err
...
func (r *Duration) unmarshalJSON(d *json.Decoder) error {
	t, err := d.Token()
	if err != nil {
		return err
	}
	if t != json.Delim('{') {
		return fmt.Errorf("invalid token: %v, expected: '{' in Duration element", t)
	}
	for d.More() {
		t, err = d.Token()
		if err != nil {
		...
		f, ok := t.(string)
		if !ok {
			return fmt.Errorf("invalid token: %v, expected: field name in Duration element", t)
		}
		switch f {
		case "id":
			var v string
		...
		default:
			return fmt.Errorf("invalid field: %s in Duration", f)
		}
	}
	t, err = d.Token()
	if err != nil {
...
func (r Duration) Children(name ...string) fhirpath.Collection {
...
func (r Duration) ToBoolean(explicit bool) (*fhirpath.Boolean, error) {
	return nil, errors.New("can not convert Duration to Boolean")
}
func (r Duration) ToString(explicit bool) (*fhirpath.String, error) {
	return nil, errors.New("can not convert Duration to String")
}
func (r Duration) ToInteger(explicit bool) (*fhirpath.Integer, error) {
	return nil, errors.New("can not convert Duration to Integer")
}
func (r Duration) ToDecimal(explicit bool) (*fhirpath.Decimal, error) {
	return nil, errors.New("can not convert Duration to Decimal")
}
func (r Duration) ToDate(explicit bool) (*fhirpath.Date, error) {
	return nil, errors.New("can not convert Duration to Date")
}
func (r Duration) ToTime(explicit bool) (*fhirpath.Time, error) {
	return nil, errors.New("can not convert Duration to Time")
}
func (r Duration) ToDateTime(explicit bool) (*fhirpath.DateTime, error) {
	return nil, errors.New("can not convert Duration to DateTime")
}
func (r Duration) ToQuantity(explicit bool) (*fhirpath.Quantity, error) {

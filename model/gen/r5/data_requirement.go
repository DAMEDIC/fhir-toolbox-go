...
func (r DataRequirement) MemSize() int {
	...
	s += (cap(r.ValueFilter) - len(r.ValueFilter)) * int(unsafe.Sizeof(DataRequirementValueFilter{}))
	if r.Limit != nil {
		s += r.Limit.MemSize()
	}
...
func (r DataRequirementValueFilter) ToBoolean(explicit bool) (*fhirpath.Boolean, error) {
	return nil, errors.New("can not convert DataRequirementValueFilter to Boolean")
}
func (r DataRequirementValueFilter) ToString(explicit bool) (*fhirpath.String, error) {
	return nil, errors.New("can not convert DataRequirementValueFilter to String")
}
func (r DataRequirementValueFilter) ToInteger(explicit bool) (*fhirpath.Integer, error) {
	return nil, errors.New("can not convert DataRequirementValueFilter to Integer")
}
func (r DataRequirementValueFilter) ToDecimal(explicit bool) (*fhirpath.Decimal, error) {
	return nil, errors.New("can not convert DataRequirementValueFilter to Decimal")
}
func (r DataRequirementValueFilter) ToDate(explicit bool) (*fhirpath.Date, error) {
	return nil, errors.New("can not convert DataRequirementValueFilter to Date")
}
func (r DataRequirementValueFilter) ToTime(explicit bool) (*fhirpath.Time, error) {
	return nil, errors.New("can not convert DataRequirementValueFilter to Time")
}
func (r DataRequirementValueFilter) ToDateTime(explicit bool) (*fhirpath.DateTime, error) {
	return nil, errors.New("can not convert DataRequirementValueFilter to DateTime")
}
func (r DataRequirementValueFilter) ToQuantity(explicit bool) (*fhirpath.Quantity, error) {

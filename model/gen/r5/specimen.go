...
func (r Specimen) MemSize() int {
	...
	if r.Combined != nil {
		s += r.Combined.MemSize()
	}
	for _, i := range r.Role {
		s += i.MemSize()
	}
	s += (cap(r.Role) - len(r.Role)) * int(reflect.TypeOf(CodeableConcept{}).Size())
	for _, i := range r.Feature {
		s += i.MemSize()
	}
	s += (cap(r.Feature) - len(r.Feature)) * int(reflect.TypeOf(SpecimenFeature{}).Size())
	if r.Collection != nil {
...
func (r SpecimenFeature) MemSize() int {
	s := int(reflect.TypeOf(r).Size())
	if r.Id != nil {
...
func (r SpecimenFeature) String() string {
	buf, err := json.MarshalIndent(r, "", "  ")
	if err != nil {
		return "null"
	}
...
func (r Specimen) marshalJSON(w io.Writer) error {
	...
	if r.Combined != nil && r.Combined.Value != nil {
		if setComma {
			_, err = w.Write([]byte(","))
			if err != nil {
				return err
		...
		enc := json.NewEncoder(w)
		enc.SetEscapeHTML(false)
		err := enc.Encode(r.Combined)
		if err != nil {
			return err
		}
	}
	if r.Combined != nil && (r.Combined.Id != nil || r.Combined.Extension != nil) {
		p := primitiveElement{Id: r.Combined.Id, Extension: r.Combined.Extension}
		if setComma {
			_, err = w.Write([]byte(","))
			if err != nil {
				return err
...
func (r SpecimenFeature) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	err := r.marshalJSON(&b)
	if err != nil {
		return nil, err
...
func (r SpecimenFeature) marshalJSON(w io.Writer) error {
	var err error
	_, err = w.Write([]byte("{"))
	if err != nil {
		return err
...
func (r *Specimen) unmarshalJSON(d *json.Decoder) error {
	...
	for d.More() {
		...
		case "_combined":
			...
			r.Combined.Id = v.Id
			r.Combined.Extension = v.Extension
		case "role":
			t, err = d.Token()
			if err != nil {
				return err
...
func (r *SpecimenFeature) unmarshalJSON(d *json.Decoder) error {
	t, err := d.Token()
	if err != nil {
		return err
	}
	if t != json.Delim('{') {
		return fmt.Errorf("invalid token: %v, expected: '{' in SpecimenFeature element", t)
	}
	for d.More() {
		t, err = d.Token()
		if err != nil {
		...
		f, ok := t.(string)
		if !ok {
			return fmt.Errorf("invalid token: %v, expected: field name in SpecimenFeature element", t)
		}
		switch f {
		case "id":
			var v string
		...
		default:
			return fmt.Errorf("invalid field: %s in SpecimenFeature", f)
		}
	}
	t, err = d.Token()
	if err != nil {
...
func (r Specimen) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	err = e.EncodeElement(r.Combined, xml.StartElement{Name: xml.Name{Local: "combined"}})
	if err != nil {
		return err
	}
	...
	err = e.EncodeElement(r.Feature, xml.StartElement{Name: xml.Name{Local: "feature"}})
	if err != nil {
		return err
	}
...
func (r SpecimenFeature) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	if r.Id != nil {
...
func (r Specimen) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {
	var o *Specimen
...
func (r SpecimenFeature) ToBoolean(explicit bool) (fhirpath.Boolean, bool, error) {
	return false, false, errors.New("can not convert SpecimenFeature to Boolean")
}
func (r SpecimenFeature) ToString(explicit bool) (fhirpath.String, bool, error) {
	return "", false, errors.New("can not convert SpecimenFeature to String")
}
func (r SpecimenFeature) ToInteger(explicit bool) (fhirpath.Integer, bool, error) {
	return 0, false, errors.New("can not convert SpecimenFeature to Integer")
}
func (r SpecimenFeature) ToDecimal(explicit bool) (fhirpath.Decimal, bool, error) {
	return fhirpath.Decimal{}, false, errors.New("can not convert SpecimenFeature to Decimal")
}
func (r SpecimenFeature) ToDate(explicit bool) (fhirpath.Date, bool, error) {
	return fhirpath.Date{}, false, errors.New("can not convert SpecimenFeature to Date")
}
func (r SpecimenFeature) ToTime(explicit bool) (fhirpath.Time, bool, error) {
	return fhirpath.Time{}, false, errors.New("can not convert SpecimenFeature to Time")
}
func (r SpecimenFeature) ToDateTime(explicit bool) (fhirpath.DateTime, bool, error) {
	return fhirpath.DateTime{}, false, errors.New("can not convert SpecimenFeature to DateTime")
}
func (r SpecimenFeature) ToQuantity(explicit bool) (fhirpath.Quantity, bool, error) {
	return fhirpath.Quantity{}, false, errors.New("can not convert SpecimenFeature to Quantity")
}
func (r SpecimenFeature) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {
...
func (r SpecimenCollection) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {
...
func (r SpecimenProcessing) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {
...
func (r SpecimenContainer) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {

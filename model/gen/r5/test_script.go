...
func (r String) isTestScriptVersionAlgorithm() {}
func (r Coding) isTestScriptVersionAlgorithm() {}
...
func (r Uri) isTestScriptSetupActionAssertRequirementLink()       {}
func (r Canonical) isTestScriptSetupActionAssertRequirementLink() {}
...
func (r TestScriptScope) String() string {
	buf, err := json.MarshalIndent(r, "", "  ")
	if err != nil {
		return "null"
	}
...
func (r TestScriptSetupActionAssertRequirement) String() string {
	buf, err := json.MarshalIndent(r, "", "  ")
	if err != nil {
		return "null"
	}
...
func (r TestScriptScope) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	err := r.marshalJSON(&b)
	if err != nil {
		return nil, err
...
func (r TestScriptScope) marshalJSON(w io.Writer) error {
	var err error
	_, err = w.Write([]byte("{"))
	if err != nil {
		return err
	...
	}
	{
		...
		enc := json.NewEncoder(w)
		enc.SetEscapeHTML(false)
		err := enc.Encode(r.Artifact)
		if err != nil {
			return err
		}
	}
	if r.Artifact.Id != nil || r.Artifact.Extension != nil {
		p := primitiveElement{Id: r.Artifact.Id, Extension: r.Artifact.Extension}
		if setComma {
			_, err = w.Write([]byte(","))
			if err != nil {
				return err
	...
	if r.Conformance != nil {
		...
		err = r.Conformance.marshalJSON(w)
		if err != nil {
			return err
		}
	}
...
func (r TestScriptSetupActionAssert) marshalJSON(w io.Writer) error {
	...
	if r.DefaultManualCompletion != nil && r.DefaultManualCompletion.Value != nil {
		if setComma {
			_, err = w.Write([]byte(","))
			if err != nil {
				return err
		...
		setComma = true
		_, err = w.Write([]byte("\"defaultManualCompletion\":"))
		if err != nil {
			return err
		}
		enc := json.NewEncoder(w)
		enc.SetEscapeHTML(false)
		err := enc.Encode(r.DefaultManualCompletion)
		if err != nil {
			return err
		}
	}
	if r.DefaultManualCompletion != nil && (r.DefaultManualCompletion.Id != nil || r.DefaultManualCompletion.Extension != nil) {
		p := primitiveElement{Id: r.DefaultManualCompletion.Id, Extension: r.DefaultManualCompletion.Extension}
		if setComma {
			_, err = w.Write([]byte(","))
			if err != nil {
				return err
		...
		setComma = true
		_, err = w.Write([]byte("\"_defaultManualCompletion\":"))
		if err != nil {
			return err
		}
		err = p.marshalJSON(w)
	...
	}
	{
		...
		setComma = true
		_, err = w.Write([]byte("\"stopTestOnFail\":"))
		if err != nil {
			return err
		}
		enc := json.NewEncoder(w)
		enc.SetEscapeHTML(false)
		err := enc.Encode(r.StopTestOnFail)
		if err != nil {
			return err
		}
	}
	if r.StopTestOnFail.Id != nil || r.StopTestOnFail.Extension != nil {
		p := primitiveElement{Id: r.StopTestOnFail.Id, Extension: r.StopTestOnFail.Extension}
		if setComma {
			_, err = w.Write([]byte(","))
			if err != nil {
				return err
		...
		setComma = true
		_, err = w.Write([]byte("\"_stopTestOnFail\":"))
		if err != nil {
			return err
		}
		err = p.marshalJSON(w)
...
func (r TestScriptSetupActionAssertRequirement) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	err := r.marshalJSON(&b)
	if err != nil {
		return nil, err
...
func (r TestScriptSetupActionAssertRequirement) marshalJSON(w io.Writer) error {
	var err error
	_, err = w.Write([]byte("{"))
	if err != nil {
		return err
	...
	case Canonical:
		if v.Value != nil {
			...
			setComma = true
			_, err = w.Write([]byte("\"linkCanonical\":"))
			if err != nil {
				return err
			}
			enc := json.NewEncoder(w)
		...
		if v.Id != nil || v.Extension != nil {
			...
			setComma = true
			_, err = w.Write([]byte("\"_linkCanonical\":"))
			if err != nil {
				return err
			}
			err = p.marshalJSON(w)
...
func (r *TestScriptScope) unmarshalJSON(d *json.Decoder) error {
	t, err := d.Token()
	if err != nil {
		return err
	}
	if t != json.Delim('{') {
		return fmt.Errorf("invalid token: %v, expected: '{' in TestScriptScope element", t)
	}
	for d.More() {
		t, err = d.Token()
		if err != nil {
		...
		f, ok := t.(string)
		if !ok {
			return fmt.Errorf("invalid token: %v, expected: field name in TestScriptScope element", t)
		}
		switch f {
		case "id":
			var v string
		...
		case "_artifact":
			...
			r.Artifact.Id = v.Id
			r.Artifact.Extension = v.Extension
		case "conformance":
			var v CodeableConcept
			err := v.unmarshalJSON(d)
			if err != nil {
		...
		case "phase":
			...
			r.Phase = &v
		default:
			return fmt.Errorf("invalid field: %s in TestScriptScope", f)
		}
	}
	t, err = d.Token()
	if err != nil {
...
func (r *TestScriptSetupActionAssert) unmarshalJSON(d *json.Decoder) error {
	...
	for d.More() {
		...
		case "defaultManualCompletion":
			...
			if r.DefaultManualCompletion == nil {
				r.DefaultManualCompletion = &Code{}
			}
			r.DefaultManualCompletion.Value = v.Value
		case "_defaultManualCompletion":
			var v primitiveElement
			err := v.unmarshalJSON(d)
			if err != nil {
				return err
			...
			r.DefaultManualCompletion.Id = v.Id
			r.DefaultManualCompletion.Extension = v.Extension
		case "expression":
			var v String
			err := d.Decode(&v)
			if err != nil {
		...
		case "stopTestOnFail":
			...
			r.StopTestOnFail.Value = v.Value
		case "_stopTestOnFail":
			...
			r.StopTestOnFail.Id = v.Id
			r.StopTestOnFail.Extension = v.Extension
...
func (r *TestScriptSetupActionAssertRequirement) unmarshalJSON(d *json.Decoder) error {
	t, err := d.Token()
	if err != nil {
		return err
	}
	if t != json.Delim('{') {
		return fmt.Errorf("invalid token: %v, expected: '{' in TestScriptSetupActionAssertRequirement element", t)
	}
	for d.More() {
		t, err = d.Token()
		if err != nil {
		...
		f, ok := t.(string)
		if !ok {
			return fmt.Errorf("invalid token: %v, expected: field name in TestScriptSetupActionAssertRequirement element", t)
		}
		switch f {
		case "id":
			var v string
		...
		case "linkUri":
			...
			if r.Link != nil {
				r.Link = Uri{
					Extension: r.Link.(Uri).Extension,
					Id:        r.Link.(Uri).Id,
					Value:     v.Value,
				}
			} else {
		...
		case "linkCanonical":
			...
			if r.Link != nil {
				r.Link = Canonical{
					Extension: r.Link.(Canonical).Extension,
					Id:        r.Link.(Canonical).Id,
					Value:     v.Value,
				}
			} else {
				r.Link = v
		...
		default:
			return fmt.Errorf("invalid field: %s in TestScriptSetupActionAssertRequirement", f)
		}
	}
	t, err = d.Token()
	if err != nil {
...
func (r TestScriptScope) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	if r.Id != nil {
		start.Attr = append(start.Attr, xml.Attr{
			Name:  xml.Name{Local: "id"},
			Value: *r.Id,
	...
	err = e.EncodeElement(r.Artifact, xml.StartElement{Name: xml.Name{Local: "artifact"}})
	if err != nil {
		return err
	}
...
func (r TestScriptSetupActionAssert) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	err = e.EncodeElement(r.DefaultManualCompletion, xml.StartElement{Name: xml.Name{Local: "defaultManualCompletion"}})
	if err != nil {
		return err
	}
	err = e.EncodeElement(r.Expression, xml.StartElement{Name: xml.Name{Local: "expression"}})
	...
	err = e.EncodeElement(r.StopTestOnFail, xml.StartElement{Name: xml.Name{Local: "stopTestOnFail"}})
	if err != nil {
		return err
	}
...
func (r TestScriptSetupActionAssertRequirement) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	if r.Id != nil {
		start.Attr = append(start.Attr, xml.Attr{
			Name:  xml.Name{Local: "id"},
			Value: *r.Id,
	...
	switch v := r.Link.(type) {
	case Uri, *Uri:
		err := e.EncodeElement(v, xml.StartElement{Name: xml.Name{Local: "linkUri"}})
		if err != nil {
			return err
		}
	case Canonical, *Canonical:
		err := e.EncodeElement(v, xml.StartElement{Name: xml.Name{Local: "linkCanonical"}})
		if err != nil {
			return err
		}
	}
...
func (r *TestScriptSetupActionAssertRequirement) UnmarshalXML(d *xml.Decoder, start xml.StartElement) error {
	...
	for {
		...
		case xml.StartElement:
			...
			case "linkUri":
				if r.Link != nil {
					return fmt.Errorf("multiple values for field \"Link\"")
				}
				var v Uri
				err := d.DecodeElement(&v, &t)
				if err != nil {
...
func (r TestScript) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {
	var o *TestScript
...
func (r TestScriptOrigin) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {
...
func (r TestScriptDestination) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {
...
func (r TestScriptMetadata) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {
...
func (r TestScriptMetadataLink) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {
...
func (r TestScriptMetadataCapability) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {
...
func (r TestScriptScope) ToBoolean(explicit bool) (fhirpath.Boolean, bool, error) {
	return false, false, errors.New("can not convert TestScriptScope to Boolean")
}
func (r TestScriptScope) ToString(explicit bool) (fhirpath.String, bool, error) {
	return "", false, errors.New("can not convert TestScriptScope to String")
}
...
func (r TestScriptScope) ToDate(explicit bool) (fhirpath.Date, bool, error) {
	return fhirpath.Date{}, false, errors.New("can not convert TestScriptScope to Date")
}
func (r TestScriptScope) ToTime(explicit bool) (fhirpath.Time, bool, error) {
	return fhirpath.Time{}, false, errors.New("can not convert TestScriptScope to Time")
}
func (r TestScriptScope) ToDateTime(explicit bool) (fhirpath.DateTime, bool, error) {
	return fhirpath.DateTime{}, false, errors.New("can not convert TestScriptScope to DateTime")
}
func (r TestScriptScope) ToQuantity(explicit bool) (fhirpath.Quantity, bool, error) {
	return fhirpath.Quantity{}, false, errors.New("can not convert TestScriptScope to Quantity")
}
func (r TestScriptScope) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {
	var o *TestScriptScope
	switch other := other.(type) {
...
func (r TestScriptScope) Equivalent(other fhirpath.Element, _noReverseTypeConversion ...bool) bool {
	o, ok := other.(TestScriptScope)
	if !ok {
		return false
	}
	r.Id = nil
...
func (r TestScriptFixture) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {
...
func (r TestScriptVariable) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {
...
func (r TestScriptSetup) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {
...
func (r TestScriptSetupAction) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {
...
func (r TestScriptSetupActionOperation) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {
...
func (r TestScriptSetupActionOperationRequestHeader) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {
...
func (r TestScriptSetupActionAssert) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {
...
func (r TestScriptSetupActionAssertRequirement) ToBoolean(explicit bool) (fhirpath.Boolean, bool, error) {
	return false, false, errors.New("can not convert TestScriptSetupActionAssertRequirement to Boolean")
}
func (r TestScriptSetupActionAssertRequirement) ToString(explicit bool) (fhirpath.String, bool, error) {
	return "", false, errors.New("can not convert TestScriptSetupActionAssertRequirement to String")
}
...
func (r TestScriptSetupActionAssertRequirement) ToDate(explicit bool) (fhirpath.Date, bool, error) {
	return fhirpath.Date{}, false, errors.New("can not convert TestScriptSetupActionAssertRequirement to Date")
}
func (r TestScriptSetupActionAssertRequirement) ToTime(explicit bool) (fhirpath.Time, bool, error) {
	return fhirpath.Time{}, false, errors.New("can not convert TestScriptSetupActionAssertRequirement to Time")
}
func (r TestScriptSetupActionAssertRequirement) ToDateTime(explicit bool) (fhirpath.DateTime, bool, error) {
	return fhirpath.DateTime{}, false, errors.New("can not convert TestScriptSetupActionAssertRequirement to DateTime")
}
func (r TestScriptSetupActionAssertRequirement) ToQuantity(explicit bool) (fhirpath.Quantity, bool, error) {
	return fhirpath.Quantity{}, false, errors.New("can not convert TestScriptSetupActionAssertRequirement to Quantity")
}
func (r TestScriptSetupActionAssertRequirement) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {
	var o *TestScriptSetupActionAssertRequirement
	switch other := other.(type) {
	case TestScriptSetupActionAssertRequirement:
		o = &other
	case *TestScriptSetupActionAssertRequirement:
		o = other
	default:
...
func (r TestScriptSetupActionAssertRequirement) Equivalent(other fhirpath.Element, _noReverseTypeConversion ...bool) bool {
	o, ok := other.(TestScriptSetupActionAssertRequirement)
	if !ok {
		return false
	}
	r.Id = nil
...
func (r TestScriptTest) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {
...
func (r TestScriptTestAction) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {
...
func (r TestScriptTeardown) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {
...
func (r TestScriptTeardownAction) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {

...
func (r TestPlanTestCase) TypeInfo() fhirpath.TypeInfo {
	return fhirpath.ClassInfo{
		Element: []fhirpath.ClassInfoElement{{
			...
			Name: "Dependency",
			Type: "List<FHIR.TestPlanTestCaseDependency>",
		}, {
			Name: "TestRun",
			Type: "List<FHIR.TestPlanTestCaseTestRun>",
		}, {
			Name: "TestData",
			Type: "List<FHIR.TestPlanTestCaseTestData>",
		}, {
			Name: "Assertion",
			Type: "List<FHIR.TestPlanTestCaseAssertion>",
		}},
		SimpleTypeInfo: fhirpath.SimpleTypeInfo{
			BaseType: fhirpath.TypeSpecifier{
				Name:      "DataType",
...
func (r TestPlanTestCaseTestRun) TypeInfo() fhirpath.TypeInfo {
	return fhirpath.ClassInfo{
		Element: []fhirpath.ClassInfoElement{{
			...
			Name: "Script",
			Type: "FHIR.TestPlanTestCaseTestRunScript",
		}},
		SimpleTypeInfo: fhirpath.SimpleTypeInfo{
			BaseType: fhirpath.TypeSpecifier{
				Name:      "DataType",

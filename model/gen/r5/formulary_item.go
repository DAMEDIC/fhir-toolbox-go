...
func (r FormularyItem) ToBoolean(explicit bool) (fhirpath.Boolean, bool, error) {
	return false, false, errors.New("can not convert FormularyItem to Boolean")
}
func (r FormularyItem) ToString(explicit bool) (fhirpath.String, bool, error) {
	return "", false, errors.New("can not convert FormularyItem to String")
}
...
func (r FormularyItem) ToDate(explicit bool) (fhirpath.Date, bool, error) {
	return fhirpath.Date{}, false, errors.New("can not convert FormularyItem to Date")
}
func (r FormularyItem) ToTime(explicit bool) (fhirpath.Time, bool, error) {
	return fhirpath.Time{}, false, errors.New("can not convert FormularyItem to Time")
}
func (r FormularyItem) ToDateTime(explicit bool) (fhirpath.DateTime, bool, error) {
	return fhirpath.DateTime{}, false, errors.New("can not convert FormularyItem to DateTime")
}

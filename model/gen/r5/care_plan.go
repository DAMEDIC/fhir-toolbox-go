...
func (r CarePlan) MemSize() int {
	...
	s += (cap(r.Addresses) - len(r.Addresses)) * int(unsafe.Sizeof(CodeableReference{}))
...
func (r CarePlanActivity) MemSize() int {
	...
	s += (cap(r.PerformedActivity) - len(r.PerformedActivity)) * int(unsafe.Sizeof(CodeableReference{}))

...
func (r Period) isCareTeamParticipantCoverage() {}
func (r Timing) isCareTeamParticipantCoverage() {}
...
func (r CareTeamParticipant) marshalJSON(w io.Writer) error {
	...
	case Period:
		...
		setComma = true
		_, err = w.Write([]byte("\"coveragePeriod\":"))
		if err != nil {
			return err
		}
		enc := json.NewEncoder(w)
	...
	case Timing:
		...
		setComma = true
		_, err = w.Write([]byte("\"coverageTiming\":"))
		if err != nil {
			return err
		}
		enc := json.NewEncoder(w)
...
func (r CareTeamParticipant) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	switch v := r.Coverage.(type) {
	case Period, *Period:
		err := e.EncodeElement(v, xml.StartElement{Name: xml.Name{Local: "coveragePeriod"}})
		if err != nil {
			return err
		}
	case Timing, *Timing:
		err := e.EncodeElement(v, xml.StartElement{Name: xml.Name{Local: "coverageTiming"}})
		if err != nil {
			return err
		}
	}
...
func (r *CareTeamParticipant) UnmarshalXML(d *xml.Decoder, start xml.StartElement) error {
	...
	for {
		...
		case xml.StartElement:
			...
			case "coveragePeriod":
				if r.Coverage != nil {
					return fmt.Errorf("multiple values for field \"Coverage\"")
				}
				var v Period
				err := d.DecodeElement(&v, &t)
				if err != nil {
...
func (r CareTeam) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {
	var o *CareTeam
...
func (r CareTeamParticipant) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {

...
func (r DateTime) isProcedureOccurrence() {}
func (r Period) isProcedureOccurrence()   {}
func (r String) isProcedureOccurrence()   {}
func (r Age) isProcedureOccurrence()      {}
...
func (r Boolean) isProcedureReported()   {}
func (r Reference) isProcedureReported() {}
...
func (r Procedure) MemSize() int {
	...
	s += (cap(r.Complication) - len(r.Complication)) * int(reflect.TypeOf(CodeableReference{}).Size())
	...
	s += (cap(r.Used) - len(r.Used)) * int(reflect.TypeOf(CodeableReference{}).Size())
...
func (r Procedure) marshalJSON(w io.Writer) error {
	...
	case Age:
		...
		setComma = true
		_, err = w.Write([]byte("\"occurrenceAge\":"))
		if err != nil {
			return err
		}
		enc := json.NewEncoder(w)
	...
	case Range:
		...
		setComma = true
		_, err = w.Write([]byte("\"occurrenceRange\":"))
		if err != nil {
			return err
		}
		enc := json.NewEncoder(w)
...
func (r Procedure) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	case Age, *Age:
		err := e.EncodeElement(v, xml.StartElement{Name: xml.Name{Local: "occurrenceAge"}})
		if err != nil {
			return err
		}
	case Range, *Range:
		err := e.EncodeElement(v, xml.StartElement{Name: xml.Name{Local: "occurrenceRange"}})
		if err != nil {
			return err
		}
	case Timing, *Timing:
	...
	err = e.EncodeElement(r.Used, xml.StartElement{Name: xml.Name{Local: "used"}})
	if err != nil {
		return err
	}

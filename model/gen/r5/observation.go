...
type Observation struct {
	...
	Instantiates isObservationInstantiates
...
type isObservationInstantiates interface {
	model.Element
	isObservationInstantiates()
}

func (r Canonical) isObservationInstantiates() {}
func (r Reference) isObservationInstantiates() {}
...
func (r Attachment) isObservationValue()      {}
func (r Reference) isObservationValue()       {}
...
func (r Attachment) isObservationComponentValue()      {}
func (r Reference) isObservationComponentValue()       {}
...
func (r Observation) MemSize() int {
	...
	if r.Instantiates != nil {
		s += r.Instantiates.MemSize()
	}
	for _, i := range r.BasedOn {
		s += i.MemSize()
	}
	s += (cap(r.BasedOn) - len(r.BasedOn)) * int(reflect.TypeOf(Reference{}).Size())
	for _, i := range r.TriggeredBy {
		s += i.MemSize()
	}
	s += (cap(r.TriggeredBy) - len(r.TriggeredBy)) * int(reflect.TypeOf(ObservationTriggeredBy{}).Size())
...
func (r ObservationTriggeredBy) MemSize() int {
	s := int(reflect.TypeOf(r).Size())
	if r.Id != nil {
	...
	s += (cap(r.ModifierExtension) - len(r.ModifierExtension)) * int(reflect.TypeOf(Extension{}).Size())
	s += r.Observation.MemSize() - int(reflect.TypeOf(r.Observation).Size())
...
func (r ObservationTriggeredBy) String() string {
	buf, err := json.MarshalIndent(r, "", "  ")
	if err != nil {
		return "null"
	}
...
func (r Observation) marshalJSON(w io.Writer) error {
	...
	case Reference:
		...
		setComma = true
		_, err = w.Write([]byte("\"instantiatesReference\":"))
		if err != nil {
			return err
		}
		enc := json.NewEncoder(w)
	...
	if len(r.TriggeredBy) > 0 {
		...
		setComma = true
		_, err = w.Write([]byte("\"triggeredBy\":"))
		if err != nil {
			return err
		}
		_, err = w.Write([]byte("["))
...
func (r ObservationTriggeredBy) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	err := r.marshalJSON(&b)
	if err != nil {
		return nil, err
...
func (r ObservationTriggeredBy) marshalJSON(w io.Writer) error {
	var err error
	_, err = w.Write([]byte("{"))
	if err != nil {
		return err
	...
	err = r.Observation.marshalJSON(w)
	if err != nil {
		return err
	}
	{
...
func (r ObservationReferenceRange) marshalJSON(w io.Writer) error {
	...
	if r.NormalValue != nil {
		...
		setComma = true
		_, err = w.Write([]byte("\"normalValue\":"))
		if err != nil {
			return err
		}
		err = r.NormalValue.marshalJSON(w)
		if err != nil {
			return err
		}
	}
...
func (r *Observation) unmarshalJSON(d *json.Decoder) error {
	...
	for d.More() {
		...
		case "instantiatesCanonical":
			...
			if r.Instantiates != nil {
				r.Instantiates = Canonical{
					Extension: r.Instantiates.(Canonical).Extension,
					Id:        r.Instantiates.(Canonical).Id,
					Value:     v.Value,
				}
			} else {
				r.Instantiates = v
		...
		case "_instantiatesCanonical":
			...
			if r.Instantiates != nil {
				r.Instantiates = Canonical{
					...
					Id:        v.Id,
					Value:     r.Instantiates.(Canonical).Value,
				}
			} else {
				r.Instantiates = Canonical{
					Extension: v.Extension,
...
func (r *ObservationTriggeredBy) unmarshalJSON(d *json.Decoder) error {
	t, err := d.Token()
	if err != nil {
		return err
	}
	if t != json.Delim('{') {
		return fmt.Errorf("invalid token: %v, expected: '{' in ObservationTriggeredBy element", t)
	}
	for d.More() {
		t, err = d.Token()
		if err != nil {
		...
		f, ok := t.(string)
		if !ok {
			return fmt.Errorf("invalid token: %v, expected: field name in ObservationTriggeredBy element", t)
		}
		switch f {
		case "id":
			var v string
		...
		default:
			return fmt.Errorf("invalid field: %s in ObservationTriggeredBy", f)
		}
	}
	t, err = d.Token()
	if err != nil {
...
func (r Observation) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	case Canonical, *Canonical:
		err := e.EncodeElement(v, xml.StartElement{Name: xml.Name{Local: "instantiatesCanonical"}})
		if err != nil {
			return err
		}
	case Reference, *Reference:
		err := e.EncodeElement(v, xml.StartElement{Name: xml.Name{Local: "instantiatesReference"}})
		if err != nil {
			return err
		}
	}
	...
	err = e.EncodeElement(r.TriggeredBy, xml.StartElement{Name: xml.Name{Local: "triggeredBy"}})
	if err != nil {
		return err
	}
...
func (r ObservationTriggeredBy) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	if r.Id != nil {
...
func (r ObservationReferenceRange) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	err = e.EncodeElement(r.NormalValue, xml.StartElement{Name: xml.Name{Local: "normalValue"}})
	if err != nil {
		return err
	}
	err = e.EncodeElement(r.Type, xml.StartElement{Name: xml.Name{Local: "type"}})
...
func (r *Observation) UnmarshalXML(d *xml.Decoder, start xml.StartElement) error {
	...
	for {
		...
		case xml.StartElement:
			...
			case "instantiatesCanonical":
				if r.Instantiates != nil {
					return fmt.Errorf("multiple values for field \"Instantiates\"")
				}
				var v Canonical
				err := d.DecodeElement(&v, &t)
				if err != nil {
...
func (r ObservationTriggeredBy) Equivalent(other fhirpath.Element, _noReverseTypeConversion ...bool) bool {
	o, ok := other.(ObservationTriggeredBy)
	if !ok {
		return false
	}
	r.Id = nil

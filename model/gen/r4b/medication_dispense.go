...
func (r MedicationDispenseSubstitution) MemSize() int {
	...
	for _, i := range r.ResponsibleParty {
		s += i.MemSize()
	}
	s += (cap(r.ResponsibleParty) - len(r.ResponsibleParty)) * int(reflect.TypeOf(Reference{}).Size())
	return s
}
...
func (r MedicationDispense) marshalJSON(w io.Writer) error {
	...
	case CodeableConcept:
		...
		setComma = true
		_, err = w.Write([]byte("\"statusReasonCodeableConcept\":"))
		if err != nil {
			return err
		}
		enc := json.NewEncoder(w)
	...
	case Reference:
		...
		setComma = true
		_, err = w.Write([]byte("\"statusReasonReference\":"))
		if err != nil {
			return err
		}
		enc := json.NewEncoder(w)
...
func (r MedicationDispenseSubstitution) marshalJSON(w io.Writer) error {
	...
	if len(r.ResponsibleParty) > 0 {
		...
		setComma = false
		for _, e := range r.ResponsibleParty {
			if setComma {
				_, err = w.Write([]byte(","))
				if err != nil {
					return err
...
func (r MedicationDispense) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	case CodeableConcept, *CodeableConcept:
		err := e.EncodeElement(v, xml.StartElement{Name: xml.Name{Local: "statusReasonCodeableConcept"}})
		if err != nil {
			return err
		}
	case Reference, *Reference:
		err := e.EncodeElement(v, xml.StartElement{Name: xml.Name{Local: "statusReasonReference"}})
		if err != nil {
			return err
		}
	}
...
func (r MedicationDispense) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {
...
func (r MedicationDispensePerformer) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {
...
func (r MedicationDispenseSubstitution) Children(name ...string) fhirpath.Collection {
	...
	if len(name) == 0 || slices.Contains(name, "responsibleParty") {
		for _, v := range r.ResponsibleParty {
			children = append(children, v)
		}
	}
	return children
...
func (r MedicationDispenseSubstitution) Equal(other fhirpath.Element, _noReverseTypeConversion ...bool) (bool, bool) {

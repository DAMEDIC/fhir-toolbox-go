...
func (r Duration) isPackagedProductDefinitionPackageShelfLifeStoragePeriod() {}
func (r String) isPackagedProductDefinitionPackageShelfLifeStoragePeriod()   {}
...
func (r CodeableConcept) isPackagedProductDefinitionPackagePropertyValue() {}
func (r Quantity) isPackagedProductDefinitionPackagePropertyValue()        {}
func (r Date) isPackagedProductDefinitionPackagePropertyValue()            {}
func (r Boolean) isPackagedProductDefinitionPackagePropertyValue()         {}
func (r Attachment) isPackagedProductDefinitionPackagePropertyValue()      {}
...
func (r PackagedProductDefinitionPackage) MemSize() int {
	s := int(unsafe.Sizeof(r))
	if r.Id != nil {
		s += len(*r.Id) + int(unsafe.Sizeof(*r.Id))
	}
	...
	s += (cap(r.ShelfLifeStorage) - len(r.ShelfLifeStorage)) * int(unsafe.Sizeof(PackagedProductDefinitionPackageShelfLifeStorage{}))
	for _, i := range r.Manufacturer {
		s += i.MemSize()
	}
	s += (cap(r.Manufacturer) - len(r.Manufacturer)) * int(unsafe.Sizeof(Reference{}))
	...
	s += (cap(r.Property) - len(r.Property)) * int(unsafe.Sizeof(PackagedProductDefinitionPackageProperty{}))
	for _, i := range r.ContainedItem {
		s += i.MemSize()
	}
	s += (cap(r.ContainedItem) - len(r.ContainedItem)) * int(unsafe.Sizeof(PackagedProductDefinitionPackageContainedItem{}))
	for _, i := range r.Package {
		s += i.MemSize()
	}
	s += (cap(r.Package) - len(r.Package)) * int(unsafe.Sizeof(PackagedProductDefinitionPackage{}))
	return s
}
func (r PackagedProductDefinitionPackageShelfLifeStorage) MemSize() int {
	s := int(unsafe.Sizeof(r))
	if r.Id != nil {
		s += len(*r.Id) + int(unsafe.Sizeof(*r.Id))
	}
...
func (r PackagedProductDefinitionPackageProperty) MemSize() int {
	s := int(unsafe.Sizeof(r))
	if r.Id != nil {
		s += len(*r.Id) + int(unsafe.Sizeof(*r.Id))
	}
...
func (r PackagedProductDefinitionPackageContainedItem) MemSize() int {
	s := int(unsafe.Sizeof(r))
	if r.Id != nil {
		s += len(*r.Id) + int(unsafe.Sizeof(*r.Id))
	}
...
func (r PackagedProductDefinitionPackage) String() string {
	buf, err := json.MarshalIndent(r, "", "  ")
	if err != nil {
		return "null"
	}
...
func (r PackagedProductDefinitionPackageShelfLifeStorage) String() string {
	buf, err := json.MarshalIndent(r, "", "  ")
	if err != nil {
		return "null"
	}
...
func (r PackagedProductDefinitionPackageProperty) String() string {
	buf, err := json.MarshalIndent(r, "", "  ")
	if err != nil {
		return "null"
	}
...
func (r PackagedProductDefinitionPackageContainedItem) String() string {
	buf, err := json.MarshalIndent(r, "", "  ")
	if err != nil {
		return "null"
	}
...
func (r PackagedProductDefinitionPackage) marshalJSON(w io.Writer) error {
	var err error
	_, err = w.Write([]byte("{"))
	if err != nil {
		return err
...
func (r PackagedProductDefinitionPackageShelfLifeStorage) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	err := r.marshalJSON(&b)
	if err != nil {
		return nil, err
...
func (r PackagedProductDefinitionPackageShelfLifeStorage) marshalJSON(w io.Writer) error {
	var err error
	_, err = w.Write([]byte("{"))
	if err != nil {
		return err
...
func (r PackagedProductDefinitionPackageProperty) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	err := r.marshalJSON(&b)
	if err != nil {
		return nil, err
...
func (r PackagedProductDefinitionPackageProperty) marshalJSON(w io.Writer) error {
	var err error
	_, err = w.Write([]byte("{"))
	if err != nil {
		return err
...
func (r PackagedProductDefinitionPackageContainedItem) MarshalJSON() ([]byte, error) {
	var b bytes.Buffer
	err := r.marshalJSON(&b)
	if err != nil {
		return nil, err
...
func (r PackagedProductDefinitionPackageContainedItem) marshalJSON(w io.Writer) error {
	var err error
	_, err = w.Write([]byte("{"))
	if err != nil {
		return err
...
func (r *PackagedProductDefinitionPackage) unmarshalJSON(d *json.Decoder) error {
	t, err := d.Token()
	if err != nil {
		return err
	}
	if t != json.Delim('{') {
		return fmt.Errorf("invalid token: %v, expected: '{' in PackagedProductDefinitionPackage element", t)
	}
	for d.More() {
		t, err = d.Token()
		if err != nil {
		...
		f, ok := t.(string)
		if !ok {
			return fmt.Errorf("invalid token: %v, expected: field name in PackagedProductDefinitionPackage element", t)
		}
		switch f {
		case "id":
			var v string
		...
		default:
			return fmt.Errorf("invalid field: %s in PackagedProductDefinitionPackage", f)
		}
	}
	t, err = d.Token()
	if err != nil {
...
func (r *PackagedProductDefinitionPackageShelfLifeStorage) unmarshalJSON(d *json.Decoder) error {
	t, err := d.Token()
	if err != nil {
		return err
	}
	if t != json.Delim('{') {
		return fmt.Errorf("invalid token: %v, expected: '{' in PackagedProductDefinitionPackageShelfLifeStorage element", t)
	}
	for d.More() {
		t, err = d.Token()
		if err != nil {
		...
		f, ok := t.(string)
		if !ok {
			return fmt.Errorf("invalid token: %v, expected: field name in PackagedProductDefinitionPackageShelfLifeStorage element", t)
		}
		switch f {
		case "id":
			var v string
		...
		default:
			return fmt.Errorf("invalid field: %s in PackagedProductDefinitionPackageShelfLifeStorage", f)
		}
	}
	t, err = d.Token()
	if err != nil {
...
func (r *PackagedProductDefinitionPackageProperty) unmarshalJSON(d *json.Decoder) error {
	t, err := d.Token()
	if err != nil {
		return err
	}
	if t != json.Delim('{') {
		return fmt.Errorf("invalid token: %v, expected: '{' in PackagedProductDefinitionPackageProperty element", t)
	}
	for d.More() {
		t, err = d.Token()
		if err != nil {
		...
		f, ok := t.(string)
		if !ok {
			return fmt.Errorf("invalid token: %v, expected: field name in PackagedProductDefinitionPackageProperty element", t)
		}
		switch f {
		case "id":
			var v string
		...
		case "valueAttachment":
			...
			r.Value = v
		default:
			return fmt.Errorf("invalid field: %s in PackagedProductDefinitionPackageProperty", f)
		}
	}
	t, err = d.Token()
	if err != nil {
...
func (r *PackagedProductDefinitionPackageContainedItem) unmarshalJSON(d *json.Decoder) error {
	t, err := d.Token()
	if err != nil {
		return err
	}
	if t != json.Delim('{') {
		return fmt.Errorf("invalid token: %v, expected: '{' in PackagedProductDefinitionPackageContainedItem element", t)
	}
	for d.More() {
		t, err = d.Token()
		if err != nil {
		...
		f, ok := t.(string)
		if !ok {
			return fmt.Errorf("invalid token: %v, expected: field name in PackagedProductDefinitionPackageContainedItem element", t)
		}
		switch f {
		case "id":
			var v string
		...
		case "amount":
			...
			r.Amount = &v
		default:
			return fmt.Errorf("invalid field: %s in PackagedProductDefinitionPackageContainedItem", f)
		}
	}
	t, err = d.Token()
	if err != nil {
...
func (r PackagedProductDefinition) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	...
	err = e.EncodeElement(r.Package, xml.StartElement{Name: xml.Name{Local: "package"}})
	if err != nil {
		return err
	}
...
func (r PackagedProductDefinitionPackage) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	if r.Id != nil {
		start.Attr = append(start.Attr, xml.Attr{
			Name:  xml.Name{Local: "id"},
			Value: *r.Id,
...
func (r PackagedProductDefinitionPackageShelfLifeStorage) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	if r.Id != nil {
		start.Attr = append(start.Attr, xml.Attr{
			Name:  xml.Name{Local: "id"},
			Value: *r.Id,
...
func (r PackagedProductDefinitionPackageProperty) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	if r.Id != nil {
		start.Attr = append(start.Attr, xml.Attr{
			Name:  xml.Name{Local: "id"},
			Value: *r.Id,
...
func (r PackagedProductDefinitionPackageContainedItem) MarshalXML(e *xml.Encoder, start xml.StartElement) error {
	if r.Id != nil {
		start.Attr = append(start.Attr, xml.Attr{
			Name:  xml.Name{Local: "id"},
			Value: *r.Id,
...
func (r PackagedProductDefinition) Children(name ...string) fhirpath.Collection {
	...
	if len(name) == 0 || slices.Contains(name, "package") {
		if r.Package != nil {
			children = append(children, *r.Package)
		}
	}
	return children
}
...
func (r PackagedProductDefinition) TypeInfo() fhirpath.TypeInfo {
	return fhirpath.ClassInfo{
		Element: []fhirpath.ClassInfoElement{{
			...
			Name: "Package",
			Type: "FHIR.PackagedProductDefinitionPackage",
		}},
...
func (r PackagedProductDefinitionPackage) TypeInfo() fhirpath.TypeInfo {
	return fhirpath.ClassInfo{
		Element: []fhirpath.ClassInfoElement{{
			...
			Type: "List<FHIR.PackagedProductDefinitionPackageShelfLifeStorage>",
		}, {
			Name: "Manufacturer",
			Type: "List<FHIR.Reference>",
		}, {
			Name: "Property",
			Type: "List<FHIR.PackagedProductDefinitionPackageProperty>",
		}, {
			Name: "ContainedItem",
			Type: "List<FHIR.PackagedProductDefinitionPackageContainedItem>",
		}, {
			Name: "Package",
			Type: "List<FHIR.PackagedProductDefinitionPackage>",
		}},
		SimpleTypeInfo: fhirpath.SimpleTypeInfo{
			BaseType: fhirpath.TypeSpecifier{
				Name:      "DataType",

...
func (r Duration) ToBoolean(explicit bool) (fhirpath.Boolean, bool, error) {
	return false, false, errors.New("can not convert Duration to Boolean")
}
func (r Duration) ToString(explicit bool) (fhirpath.String, bool, error) {
	return "", false, errors.New("can not convert Duration to String")
}
...
func (r Duration) ToDate(explicit bool) (fhirpath.Date, bool, error) {
	return fhirpath.Date{}, false, errors.New("can not convert Duration to Date")
}
func (r Duration) ToTime(explicit bool) (fhirpath.Time, bool, error) {
	return fhirpath.Time{}, false, errors.New("can not convert Duration to Time")
}
func (r Duration) ToDateTime(explicit bool) (fhirpath.DateTime, bool, error) {
	return fhirpath.DateTime{}, false, errors.New("can not convert Duration to DateTime")
}

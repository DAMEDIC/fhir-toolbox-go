...
func AllCapabilities(api any) (capabilities.Capabilities, capabilities.FHIRError) {
	...
	if c, ok := api.(ActorDefinitionSearch); ok {
		capability, err := c.SearchCapabilitiesActorDefinition()
		if err != nil {
			errs = append(errs, err)
		} else {
	...
	if c, ok := api.(ArtifactAssessmentSearch); ok {
		capability, err := c.SearchCapabilitiesArtifactAssessment()
		if err != nil {
			errs = append(errs, err)
		} else {
	...
	if c, ok := api.(BiologicallyDerivedProductDispenseSearch); ok {
		capability, err := c.SearchCapabilitiesBiologicallyDerivedProductDispense()
		if err != nil {
			errs = append(errs, err)
		} else {
	...
	if c, ok := api.(ConditionDefinitionSearch); ok {
		capability, err := c.SearchCapabilitiesConditionDefinition()
		if err != nil {
			errs = append(errs, err)
		} else {
	...
	if c, ok := api.(DeviceAssociationSearch); ok {
		capability, err := c.SearchCapabilitiesDeviceAssociation()
		if err != nil {
			errs = append(errs, err)
		} else {
	...
	if c, ok := api.(DeviceDispenseSearch); ok {
		capability, err := c.SearchCapabilitiesDeviceDispense()
		if err != nil {
			errs = append(errs, err)
		} else {
	...
	if c, ok := api.(DeviceUsageSearch); ok {
		capability, err := c.SearchCapabilitiesDeviceUsage()
		if err != nil {
			errs = append(errs, err)
		} else {
	...
	if c, ok := api.(EncounterHistorySearch); ok {
		capability, err := c.SearchCapabilitiesEncounterHistory()
		if err != nil {
			errs = append(errs, err)
		} else {
	...
	if c, ok := api.(FormularyItemSearch); ok {
		capability, err := c.SearchCapabilitiesFormularyItem()
		if err != nil {
			errs = append(errs, err)
		} else {
	...
	if c, ok := api.(GenomicStudySearch); ok {
		capability, err := c.SearchCapabilitiesGenomicStudy()
		if err != nil {
			errs = append(errs, err)
		} else {
	...
	if c, ok := api.(ImagingSelectionSearch); ok {
		capability, err := c.SearchCapabilitiesImagingSelection()
		if err != nil {
			errs = append(errs, err)
		} else {
	...
	if c, ok := api.(InventoryItemSearch); ok {
		capability, err := c.SearchCapabilitiesInventoryItem()
		if err != nil {
			errs = append(errs, err)
		} else {
	...
	if c, ok := api.(InventoryReportSearch); ok {
		capability, err := c.SearchCapabilitiesInventoryReport()
		if err != nil {
			errs = append(errs, err)
		} else {
	...
	if c, ok := api.(NutritionIntakeSearch); ok {
		capability, err := c.SearchCapabilitiesNutritionIntake()
		if err != nil {
			errs = append(errs, err)
		} else {
	...
	if c, ok := api.(PermissionSearch); ok {
		capability, err := c.SearchCapabilitiesPermission()
		if err != nil {
			errs = append(errs, err)
		} else {
	...
	if c, ok := api.(RequestOrchestrationSearch); ok {
		capability, err := c.SearchCapabilitiesRequestOrchestration()
		if err != nil {
			errs = append(errs, err)
		} else {
	...
	if c, ok := api.(RequirementsSearch); ok {
		capability, err := c.SearchCapabilitiesRequirements()
		if err != nil {
			errs = append(errs, err)
		} else {
	...
	if c, ok := api.(TestPlanSearch); ok {
		capability, err := c.SearchCapabilitiesTestPlan()
		if err != nil {
			errs = append(errs, err)
		} else {
	...
	if c, ok := api.(TransportSearch); ok {
		capability, err := c.SearchCapabilitiesTransport()
		if err != nil {
			errs = append(errs, err)
		} else {

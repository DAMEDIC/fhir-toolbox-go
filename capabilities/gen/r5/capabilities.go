...
func AllCapabilities(api any) capabilities.Capabilities {
	...
	if c, ok := api.(ActorDefinitionSearch); ok {
		search["ActorDefinition"] = c.SearchCapabilitiesActorDefinition()
	}
	...
	if c, ok := api.(AdministrableProductDefinitionSearch); ok {
		search["AdministrableProductDefinition"] = c.SearchCapabilitiesAdministrableProductDefinition()
	}
	...
	if c, ok := api.(ArtifactAssessmentSearch); ok {
		search["ArtifactAssessment"] = c.SearchCapabilitiesArtifactAssessment()
	}
	...
	if c, ok := api.(BiologicallyDerivedProductDispenseSearch); ok {
		search["BiologicallyDerivedProductDispense"] = c.SearchCapabilitiesBiologicallyDerivedProductDispense()
	}
	...
	if c, ok := api.(CitationSearch); ok {
		search["Citation"] = c.SearchCapabilitiesCitation()
	}
	...
	if c, ok := api.(ClinicalUseDefinitionSearch); ok {
		search["ClinicalUseDefinition"] = c.SearchCapabilitiesClinicalUseDefinition()
	}
	...
	if c, ok := api.(ConditionDefinitionSearch); ok {
		search["ConditionDefinition"] = c.SearchCapabilitiesConditionDefinition()
	}
	...
	if c, ok := api.(DeviceAssociationSearch); ok {
		search["DeviceAssociation"] = c.SearchCapabilitiesDeviceAssociation()
	}
	...
	if c, ok := api.(DeviceDispenseSearch); ok {
		search["DeviceDispense"] = c.SearchCapabilitiesDeviceDispense()
	}
	...
	if c, ok := api.(DeviceUsageSearch); ok {
		search["DeviceUsage"] = c.SearchCapabilitiesDeviceUsage()
	}
	...
	if c, ok := api.(EncounterHistorySearch); ok {
		search["EncounterHistory"] = c.SearchCapabilitiesEncounterHistory()
	}
	...
	if c, ok := api.(EvidenceReportSearch); ok {
		search["EvidenceReport"] = c.SearchCapabilitiesEvidenceReport()
	}
	...
	if c, ok := api.(FormularyItemSearch); ok {
		search["FormularyItem"] = c.SearchCapabilitiesFormularyItem()
	}
	if _, ok := api.(GenomicStudyRead); ok {
		read = append(read, "GenomicStudy")
	}
	if c, ok := api.(GenomicStudySearch); ok {
		search["GenomicStudy"] = c.SearchCapabilitiesGenomicStudy()
	}
	...
	if c, ok := api.(ImagingSelectionSearch); ok {
		search["ImagingSelection"] = c.SearchCapabilitiesImagingSelection()
	}
	...
	if c, ok := api.(IngredientSearch); ok {
		search["Ingredient"] = c.SearchCapabilitiesIngredient()
	}
	...
	if c, ok := api.(InventoryItemSearch); ok {
		search["InventoryItem"] = c.SearchCapabilitiesInventoryItem()
	}
	if _, ok := api.(InventoryReportRead); ok {
		read = append(read, "InventoryReport")
	}
	if c, ok := api.(InventoryReportSearch); ok {
		search["InventoryReport"] = c.SearchCapabilitiesInventoryReport()
	}
	...
	if c, ok := api.(ManufacturedItemDefinitionSearch); ok {
		search["ManufacturedItemDefinition"] = c.SearchCapabilitiesManufacturedItemDefinition()
	}
	...
	if c, ok := api.(MedicinalProductDefinitionSearch); ok {
		search["MedicinalProductDefinition"] = c.SearchCapabilitiesMedicinalProductDefinition()
	}
	...
	if c, ok := api.(NutritionIntakeSearch); ok {
		search["NutritionIntake"] = c.SearchCapabilitiesNutritionIntake()
	}
	...
	if c, ok := api.(NutritionProductSearch); ok {
		search["NutritionProduct"] = c.SearchCapabilitiesNutritionProduct()
	}
	...
	if c, ok := api.(PackagedProductDefinitionSearch); ok {
		search["PackagedProductDefinition"] = c.SearchCapabilitiesPackagedProductDefinition()
	}
	...
	if c, ok := api.(PermissionSearch); ok {
		search["Permission"] = c.SearchCapabilitiesPermission()
	}
	...
	if c, ok := api.(RegulatedAuthorizationSearch); ok {
		search["RegulatedAuthorization"] = c.SearchCapabilitiesRegulatedAuthorization()
	}
	...
	if c, ok := api.(RequestOrchestrationSearch); ok {
		search["RequestOrchestration"] = c.SearchCapabilitiesRequestOrchestration()
	}
	if _, ok := api.(RequirementsRead); ok {
		read = append(read, "Requirements")
	}
	if c, ok := api.(RequirementsSearch); ok {
		search["Requirements"] = c.SearchCapabilitiesRequirements()
	}
	...
	if c, ok := api.(SubscriptionStatusSearch); ok {
		search["SubscriptionStatus"] = c.SearchCapabilitiesSubscriptionStatus()
	}
	if _, ok := api.(SubscriptionTopicRead); ok {
		read = append(read, "SubscriptionTopic")
	}
	if c, ok := api.(SubscriptionTopicSearch); ok {
		search["SubscriptionTopic"] = c.SearchCapabilitiesSubscriptionTopic()
	}
	...
	if c, ok := api.(SubstanceDefinitionSearch); ok {
		search["SubstanceDefinition"] = c.SearchCapabilitiesSubstanceDefinition()
	}
	...
	if c, ok := api.(TestPlanSearch); ok {
		search["TestPlan"] = c.SearchCapabilitiesTestPlan()
	}
	...
	if c, ok := api.(TransportSearch); ok {
		search["Transport"] = c.SearchCapabilitiesTransport()
	}

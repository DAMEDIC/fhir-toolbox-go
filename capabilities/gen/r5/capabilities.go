...
func AllCapabilities(ctx context.Context, api any) (capabilities.Capabilities, error) {
	...
	if c, ok := api.(ActorDefinitionSearch); ok {
		...
		if err != nil {
			...
			allCapabilities.Search["ActorDefinition"] = search.Capabilities[search.Parameter]{
				Includes:   c.Includes,
				Parameters: make(map[string]search.Parameter),
			}
			for n, p := range c.Parameters {
				allCapabilities.Search["ActorDefinition"].Parameters[n] = p
			}
		}
	}
	...
	if c, ok := api.(ArtifactAssessmentSearch); ok {
		...
		if err != nil {
			...
			allCapabilities.Search["ArtifactAssessment"] = search.Capabilities[search.Parameter]{
				Includes:   c.Includes,
				Parameters: make(map[string]search.Parameter),
			}
			for n, p := range c.Parameters {
				allCapabilities.Search["ArtifactAssessment"].Parameters[n] = p
			}
		}
	}
	...
	if c, ok := api.(BiologicallyDerivedProductDispenseSearch); ok {
		...
		if err != nil {
			...
			allCapabilities.Search["BiologicallyDerivedProductDispense"] = search.Capabilities[search.Parameter]{
				Includes:   c.Includes,
				Parameters: make(map[string]search.Parameter),
			}
			for n, p := range c.Parameters {
				allCapabilities.Search["BiologicallyDerivedProductDispense"].Parameters[n] = p
			}
		}
	}
	...
	if c, ok := api.(ConditionDefinitionSearch); ok {
		...
		if err != nil {
			...
			allCapabilities.Search["ConditionDefinition"] = search.Capabilities[search.Parameter]{
				Includes:   c.Includes,
				Parameters: make(map[string]search.Parameter),
			}
			for n, p := range c.Parameters {
				allCapabilities.Search["ConditionDefinition"].Parameters[n] = p
			}
		}
	}
	...
	if c, ok := api.(DeviceAssociationSearch); ok {
		...
		if err != nil {
			...
			allCapabilities.Search["DeviceAssociation"] = search.Capabilities[search.Parameter]{
				Includes:   c.Includes,
				Parameters: make(map[string]search.Parameter),
			}
			for n, p := range c.Parameters {
				allCapabilities.Search["DeviceAssociation"].Parameters[n] = p
			}
		}
	}
	...
	if c, ok := api.(DeviceDispenseSearch); ok {
		...
		if err != nil {
			...
			allCapabilities.Search["DeviceDispense"] = search.Capabilities[search.Parameter]{
				Includes:   c.Includes,
				Parameters: make(map[string]search.Parameter),
			}
			for n, p := range c.Parameters {
				allCapabilities.Search["DeviceDispense"].Parameters[n] = p
			}
		}
	}
	...
	if c, ok := api.(DeviceUsageSearch); ok {
		...
		if err != nil {
			...
			allCapabilities.Search["DeviceUsage"] = search.Capabilities[search.Parameter]{
				Includes:   c.Includes,
				Parameters: make(map[string]search.Parameter),
			}
			for n, p := range c.Parameters {
				allCapabilities.Search["DeviceUsage"].Parameters[n] = p
			}
		}
	}
	...
	if c, ok := api.(EncounterHistorySearch); ok {
		...
		if err != nil {
			...
			allCapabilities.Search["EncounterHistory"] = search.Capabilities[search.Parameter]{
				Includes:   c.Includes,
				Parameters: make(map[string]search.Parameter),
			}
			for n, p := range c.Parameters {
				allCapabilities.Search["EncounterHistory"].Parameters[n] = p
			}
		}
	}
	...
	if c, ok := api.(FormularyItemSearch); ok {
		...
		if err != nil {
			...
			allCapabilities.Search["FormularyItem"] = search.Capabilities[search.Parameter]{
				Includes:   c.Includes,
				Parameters: make(map[string]search.Parameter),
			}
			for n, p := range c.Parameters {
				allCapabilities.Search["FormularyItem"].Parameters[n] = p
			}
		}
	}
	...
	if c, ok := api.(GenomicStudySearch); ok {
		...
		if err != nil {
			...
			allCapabilities.Search["GenomicStudy"] = search.Capabilities[search.Parameter]{
				Includes:   c.Includes,
				Parameters: make(map[string]search.Parameter),
			}
			for n, p := range c.Parameters {
				allCapabilities.Search["GenomicStudy"].Parameters[n] = p
			}
		}
	}
	...
	if c, ok := api.(ImagingSelectionSearch); ok {
		...
		if err != nil {
			...
			allCapabilities.Search["ImagingSelection"] = search.Capabilities[search.Parameter]{
				Includes:   c.Includes,
				Parameters: make(map[string]search.Parameter),
			}
			for n, p := range c.Parameters {
				allCapabilities.Search["ImagingSelection"].Parameters[n] = p
			}
		}
	}
	...
	if c, ok := api.(InventoryItemSearch); ok {
		...
		if err != nil {
			...
			allCapabilities.Search["InventoryItem"] = search.Capabilities[search.Parameter]{
				Includes:   c.Includes,
				Parameters: make(map[string]search.Parameter),
			}
			for n, p := range c.Parameters {
				allCapabilities.Search["InventoryItem"].Parameters[n] = p
			}
		}
	}
	...
	if c, ok := api.(InventoryReportSearch); ok {
		...
		if err != nil {
			...
			allCapabilities.Search["InventoryReport"] = search.Capabilities[search.Parameter]{
				Includes:   c.Includes,
				Parameters: make(map[string]search.Parameter),
			}
			for n, p := range c.Parameters {
				allCapabilities.Search["InventoryReport"].Parameters[n] = p
			}
		}
	}
	...
	if c, ok := api.(NutritionIntakeSearch); ok {
		...
		if err != nil {
			...
			allCapabilities.Search["NutritionIntake"] = search.Capabilities[search.Parameter]{
				Includes:   c.Includes,
				Parameters: make(map[string]search.Parameter),
			}
			for n, p := range c.Parameters {
				allCapabilities.Search["NutritionIntake"].Parameters[n] = p
			}
		}
	}
	...
	if c, ok := api.(PermissionSearch); ok {
		...
		if err != nil {
			...
			allCapabilities.Search["Permission"] = search.Capabilities[search.Parameter]{
				Includes:   c.Includes,
				Parameters: make(map[string]search.Parameter),
			}
			for n, p := range c.Parameters {
				allCapabilities.Search["Permission"].Parameters[n] = p
			}
		}
	}
	...
	if c, ok := api.(RequestOrchestrationSearch); ok {
		...
		if err != nil {
			...
			allCapabilities.Search["RequestOrchestration"] = search.Capabilities[search.Parameter]{
				Includes:   c.Includes,
				Parameters: make(map[string]search.Parameter),
			}
			for n, p := range c.Parameters {
				allCapabilities.Search["RequestOrchestration"].Parameters[n] = p
			}
		}
	}
	...
	if c, ok := api.(RequirementsSearch); ok {
		...
		if err != nil {
			...
			allCapabilities.Search["Requirements"] = search.Capabilities[search.Parameter]{
				Includes:   c.Includes,
				Parameters: make(map[string]search.Parameter),
			}
			for n, p := range c.Parameters {
				allCapabilities.Search["Requirements"].Parameters[n] = p
			}
		}
	}
	...
	if c, ok := api.(TestPlanSearch); ok {
		...
		if err != nil {
			...
			allCapabilities.Search["TestPlan"] = search.Capabilities[search.Parameter]{
				Includes:   c.Includes,
				Parameters: make(map[string]search.Parameter),
			}
			for n, p := range c.Parameters {
				allCapabilities.Search["TestPlan"].Parameters[n] = p
			}
		}
	}
	...
	if c, ok := api.(TransportSearch); ok {
		...
		if err != nil {
			...
			allCapabilities.Search["Transport"] = search.Capabilities[search.Parameter]{
				Includes:   c.Includes,
				Parameters: make(map[string]search.Parameter),
			}
			for n, p := range c.Parameters {
				allCapabilities.Search["Transport"].Parameters[n] = p
			}
		}
	}

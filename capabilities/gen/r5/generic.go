...
func (w Generic) CapabilityStatement(ctx context.Context) (basic.CapabilityStatement, error) {
	...
	if capabilityStatement.FhirVersion.Value == nil {
		capabilityStatement.FhirVersion = basic.Code{Value: ptr.To("5.0.0")}
	}
...
func searchParameters(ctx context.Context, api any) (map[string]r5.SearchParameter, error) {
...
func (w Generic) SearchCapabilities(ctx context.Context, resourceType string) (search.Capabilities[r5.SearchParameter], error) {
	switch resourceType {
	case "Account":
		impl, ok := w.Concrete.(AccountSearch)
		if !ok {
			return search.Capabilities[r5.SearchParameter]{}, r5.OperationOutcome{Issue: []r5.OperationOutcomeIssue{{
				Code:        r5.Code{Value: ptr.To("not-supported")},

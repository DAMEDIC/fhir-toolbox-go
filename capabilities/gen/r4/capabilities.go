...
func AllCapabilities(ctx context.Context, api any) (capabilities.Capabilities, error) {
	...
	if _, ok := api.(EffectEvidenceSynthesisCreate); ok {
		allCapabilities.Create["EffectEvidenceSynthesis"] = create.Capabilities{}
	}
	if _, ok := api.(EffectEvidenceSynthesisRead); ok {
		allCapabilities.Read["EffectEvidenceSynthesis"] = read.Capabilities{}
	}
	if _, ok := api.(EffectEvidenceSynthesisDelete); ok {
		allCapabilities.Delete["EffectEvidenceSynthesis"] = deletion.Capabilities{}
	}
	if c, ok := api.(EffectEvidenceSynthesisUpdate); ok {
		allCapabilities.Update["EffectEvidenceSynthesis"] = update.Capabilities{}
		...
		if ok {
			...
			if err != nil {
				...
				allCapabilities.Update["EffectEvidenceSynthesis"] = c
			}
		}
	}
	...
	if _, ok := api.(MedicinalProductCreate); ok {
		allCapabilities.Create["MedicinalProduct"] = create.Capabilities{}
	}
	if _, ok := api.(MedicinalProductRead); ok {
		allCapabilities.Read["MedicinalProduct"] = read.Capabilities{}
	}
	if _, ok := api.(MedicinalProductDelete); ok {
		allCapabilities.Delete["MedicinalProduct"] = deletion.Capabilities{}
	}
	if c, ok := api.(MedicinalProductUpdate); ok {
		allCapabilities.Update["MedicinalProduct"] = update.Capabilities{}
		...
		if ok {
			...
			if err != nil {
				...
				allCapabilities.Update["MedicinalProduct"] = c
			}
		}
	}
	...
	if _, ok := api.(MedicinalProductAuthorizationCreate); ok {
		allCapabilities.Create["MedicinalProductAuthorization"] = create.Capabilities{}
	}
	if _, ok := api.(MedicinalProductAuthorizationRead); ok {
		allCapabilities.Read["MedicinalProductAuthorization"] = read.Capabilities{}
	}
	if _, ok := api.(MedicinalProductAuthorizationDelete); ok {
		allCapabilities.Delete["MedicinalProductAuthorization"] = deletion.Capabilities{}
	}
	if c, ok := api.(MedicinalProductAuthorizationUpdate); ok {
		allCapabilities.Update["MedicinalProductAuthorization"] = update.Capabilities{}
		...
		if ok {
			...
			if err != nil {
				...
				allCapabilities.Update["MedicinalProductAuthorization"] = c
			}
		}
	}
	...
	if _, ok := api.(MedicinalProductContraindicationCreate); ok {
		allCapabilities.Create["MedicinalProductContraindication"] = create.Capabilities{}
	}
	if _, ok := api.(MedicinalProductContraindicationRead); ok {
		allCapabilities.Read["MedicinalProductContraindication"] = read.Capabilities{}
	}
	if _, ok := api.(MedicinalProductContraindicationDelete); ok {
		allCapabilities.Delete["MedicinalProductContraindication"] = deletion.Capabilities{}
	}
	if c, ok := api.(MedicinalProductContraindicationUpdate); ok {
		allCapabilities.Update["MedicinalProductContraindication"] = update.Capabilities{}
		...
		if ok {
			...
			if err != nil {
				...
				allCapabilities.Update["MedicinalProductContraindication"] = c
			}
		}
	}
	...
	if _, ok := api.(MedicinalProductIndicationCreate); ok {
		allCapabilities.Create["MedicinalProductIndication"] = create.Capabilities{}
	}
	if _, ok := api.(MedicinalProductIndicationRead); ok {
		allCapabilities.Read["MedicinalProductIndication"] = read.Capabilities{}
	}
	if _, ok := api.(MedicinalProductIndicationDelete); ok {
		allCapabilities.Delete["MedicinalProductIndication"] = deletion.Capabilities{}
	}
	if c, ok := api.(MedicinalProductIndicationUpdate); ok {
		allCapabilities.Update["MedicinalProductIndication"] = update.Capabilities{}
		...
		if ok {
			...
			if err != nil {
				...
				allCapabilities.Update["MedicinalProductIndication"] = c
			}
		}
	}
	...
	if _, ok := api.(MedicinalProductIngredientCreate); ok {
		allCapabilities.Create["MedicinalProductIngredient"] = create.Capabilities{}
	}
	if _, ok := api.(MedicinalProductIngredientRead); ok {
		allCapabilities.Read["MedicinalProductIngredient"] = read.Capabilities{}
	}
	if _, ok := api.(MedicinalProductIngredientDelete); ok {
		allCapabilities.Delete["MedicinalProductIngredient"] = deletion.Capabilities{}
	}
	if c, ok := api.(MedicinalProductIngredientUpdate); ok {
		allCapabilities.Update["MedicinalProductIngredient"] = update.Capabilities{}
		...
		if ok {
			...
			if err != nil {
				...
				allCapabilities.Update["MedicinalProductIngredient"] = c
			}
		}
	}
	...
	if _, ok := api.(MedicinalProductInteractionCreate); ok {
		allCapabilities.Create["MedicinalProductInteraction"] = create.Capabilities{}
	}
	if _, ok := api.(MedicinalProductInteractionRead); ok {
		allCapabilities.Read["MedicinalProductInteraction"] = read.Capabilities{}
	}
	if _, ok := api.(MedicinalProductInteractionDelete); ok {
		allCapabilities.Delete["MedicinalProductInteraction"] = deletion.Capabilities{}
	}
	if c, ok := api.(MedicinalProductInteractionUpdate); ok {
		allCapabilities.Update["MedicinalProductInteraction"] = update.Capabilities{}
		...
		if ok {
			...
			if err != nil {
				...
				allCapabilities.Update["MedicinalProductInteraction"] = c
			}
		}
	}
	...
	if _, ok := api.(MedicinalProductManufacturedCreate); ok {
		allCapabilities.Create["MedicinalProductManufactured"] = create.Capabilities{}
	}
	if _, ok := api.(MedicinalProductManufacturedRead); ok {
		allCapabilities.Read["MedicinalProductManufactured"] = read.Capabilities{}
	}
	if _, ok := api.(MedicinalProductManufacturedDelete); ok {
		allCapabilities.Delete["MedicinalProductManufactured"] = deletion.Capabilities{}
	}
	if c, ok := api.(MedicinalProductManufacturedUpdate); ok {
		allCapabilities.Update["MedicinalProductManufactured"] = update.Capabilities{}
		...
		if ok {
			...
			if err != nil {
				...
				allCapabilities.Update["MedicinalProductManufactured"] = c
			}
		}
	}
	...
	if _, ok := api.(MedicinalProductPackagedCreate); ok {
		allCapabilities.Create["MedicinalProductPackaged"] = create.Capabilities{}
	}
	if _, ok := api.(MedicinalProductPackagedRead); ok {
		allCapabilities.Read["MedicinalProductPackaged"] = read.Capabilities{}
	}
	if _, ok := api.(MedicinalProductPackagedDelete); ok {
		allCapabilities.Delete["MedicinalProductPackaged"] = deletion.Capabilities{}
	}
	if c, ok := api.(MedicinalProductPackagedUpdate); ok {
		allCapabilities.Update["MedicinalProductPackaged"] = update.Capabilities{}
		...
		if ok {
			...
			if err != nil {
				...
				allCapabilities.Update["MedicinalProductPackaged"] = c
			}
		}
	}
	...
	if _, ok := api.(MedicinalProductPharmaceuticalCreate); ok {
		allCapabilities.Create["MedicinalProductPharmaceutical"] = create.Capabilities{}
	}
	if _, ok := api.(MedicinalProductPharmaceuticalRead); ok {
		allCapabilities.Read["MedicinalProductPharmaceutical"] = read.Capabilities{}
	}
	if _, ok := api.(MedicinalProductPharmaceuticalDelete); ok {
		allCapabilities.Delete["MedicinalProductPharmaceutical"] = deletion.Capabilities{}
	}
	if c, ok := api.(MedicinalProductPharmaceuticalUpdate); ok {
		allCapabilities.Update["MedicinalProductPharmaceutical"] = update.Capabilities{}
		...
		if ok {
			...
			if err != nil {
				...
				allCapabilities.Update["MedicinalProductPharmaceutical"] = c
			}
		}
	}
	...
	if _, ok := api.(MedicinalProductUndesirableEffectCreate); ok {
		allCapabilities.Create["MedicinalProductUndesirableEffect"] = create.Capabilities{}
	}
	if _, ok := api.(MedicinalProductUndesirableEffectRead); ok {
		allCapabilities.Read["MedicinalProductUndesirableEffect"] = read.Capabilities{}
	}
	if _, ok := api.(MedicinalProductUndesirableEffectDelete); ok {
		allCapabilities.Delete["MedicinalProductUndesirableEffect"] = deletion.Capabilities{}
	}
	if c, ok := api.(MedicinalProductUndesirableEffectUpdate); ok {
		allCapabilities.Update["MedicinalProductUndesirableEffect"] = update.Capabilities{}
		...
		if ok {
			...
			if err != nil {
				...
				allCapabilities.Update["MedicinalProductUndesirableEffect"] = c
			}
		}
	}
	...
	if _, ok := api.(RiskEvidenceSynthesisCreate); ok {
		allCapabilities.Create["RiskEvidenceSynthesis"] = create.Capabilities{}
	}
	if _, ok := api.(RiskEvidenceSynthesisRead); ok {
		allCapabilities.Read["RiskEvidenceSynthesis"] = read.Capabilities{}
	}
	if _, ok := api.(RiskEvidenceSynthesisDelete); ok {
		allCapabilities.Delete["RiskEvidenceSynthesis"] = deletion.Capabilities{}
	}
	if c, ok := api.(RiskEvidenceSynthesisUpdate); ok {
		allCapabilities.Update["RiskEvidenceSynthesis"] = update.Capabilities{}
		...
		if ok {
			...
			if err != nil {
				...
				allCapabilities.Update["RiskEvidenceSynthesis"] = c
			}
		}
	}
	...
	if _, ok := api.(SubstanceSpecificationCreate); ok {
		allCapabilities.Create["SubstanceSpecification"] = create.Capabilities{}
	}
	if _, ok := api.(SubstanceSpecificationRead); ok {
		allCapabilities.Read["SubstanceSpecification"] = read.Capabilities{}
	}
	if _, ok := api.(SubstanceSpecificationDelete); ok {
		allCapabilities.Delete["SubstanceSpecification"] = deletion.Capabilities{}
	}
	if c, ok := api.(SubstanceSpecificationUpdate); ok {
		allCapabilities.Update["SubstanceSpecification"] = update.Capabilities{}
		...
		if ok {
			...
			if err != nil {
				...
				allCapabilities.Update["SubstanceSpecification"] = c
			}
		}
	}

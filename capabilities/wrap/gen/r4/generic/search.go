...
func (w InternalWrapper) SearchCapabilities(resourceType string) (search.Capabilities, capabilities.FHIRError) {
	switch resourceType {
	case "Account":
...
func (w InternalWrapper) Search(ctx context.Context, resourceType string, options search.Options) (search.Result, capabilities.FHIRError) {
	switch resourceType {
	case "Account":
		impl, ok := w.API.(r4.AccountSearch)
		if !ok {
